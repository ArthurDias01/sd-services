        ...
        createResult(e, t) {
          ...
          if (t._optimisticResults) {
            let r = this.hasListeners(),
              a = !r && c(e, t),
              l = r && d(e, s, t, n);
            ((a || l) && (b = { ...b, ...(0, i.fetchState)(v.data, e.options) }),
              "isRestoring" === t._optimisticResults && (b.fetchStatus = "idle"));
          }
          let { error: y, errorUpdatedAt: R, status: g } = b;
          r = b.data;
          let x = !1;
            ...
            (o?.isPlaceholderData && t.placeholderData === h?.placeholderData
              ...
              : (e =
                  "function" == typeof t.placeholderData
                    ...
                    : t.placeholderData),
              void 0 !== e && ((g = "success"), (r = (0, l.replaceData)(o?.data, e, t)), (m = !0)));
          }
          ...
          this.#t && ((y = this.#t), (r = this.#u), (R = Date.now()), (g = "error"));
          let Q = "fetching" === b.fetchStatus,
            w = "pending" === g,
            T = "error" === g,
            I = w && Q,
            S = void 0 !== r,
          ...
          if (this.options.experimental_prefetchInRender) {
            let t = void 0 !== j.data,
              ...
              n = () => {
                i((this.#r = j.promise = (0, a.pendingThenable)()));
              },
              l = this.#r;
            switch (l.status) {
              case "pending":
      ...
      return (function (e, t, r) {
        ...
        if (
          (f.useSyncExternalStore(
            f.useCallback(
              (e) => {
                let t = R ? d.subscribe(s.notifyManager.batchCalls(e)) : l.noop;
        ...
        if (
          ...
          u.experimental_prefetchInRender && !l.isServer && p.isLoading && p.isFetching && !n)
        ) {
          let e = h ? y(u, d, a) : c?.promise;
  ...
  (e) => {
    ...
    function l() {
      ...
      l[0] === Symbol.for("react.memo_cache_sentinel")
        ? ((e = { queryKey: ["projects", "admin"], queryFn: c }), (l[0] = e))
        : (e = l[0]);
      let { data: h, isPending: d } = (0, i.useQuery)(e);
      return (
              ...
              children: [
                (0, t.jsx)("span", {
                  className: (0, a.cn)(
                    ...
                    e.published ? "text-[var(--p-toffee)]" : "text-[var(--p-coffee-bean)]/60",
                  ),
    ...
    function u(e) {
      return (0, t.jsxs)(
        "div",
        {
          ...
          children: [
            (0, t.jsx)("div", { className: "h-4 w-28 rounded bg-[var(--p-warm-white)]" }),
            (0, t.jsx)("div", { className: "h-3 w-20 rounded bg-[var(--p-warm-white)]" }),
          ],
        },
        e,
      );
    ...
    function c() {
      return n.client.project.listAdmin();
    }
    e.s(["default", () => l]);
  },
]);
