(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    (t.s(["LayoutGroupContext", () => a], 31178), t.s(["useConstant", () => l], 47414));
    let h = "u" > typeof window,
      u = h ? o.useLayoutEffect : o.useEffect;
    t.s(["useIsomorphicLayoutEffect", () => u], 74008);
    let d = (0, o.createContext)(null);
    function c(t) {
      return "object" == typeof t && null !== t;
    }
    function p(t) {
      return c(t) && "offsetHeight" in t;
    }
    (t.s(["PresenceContext", () => d], 21476), t.s(["isHTMLElement", () => p], 72846));
    ...
    function f(t = !0) {
      ...
      let a = (0, o.useCallback)(() => t && n && n(r), [r, n, t]);
      return !i && n ? [!1, a] : [!0];
    }
    (t.s(["MotionConfigContext", () => m], 37806), t.s(["usePresence", () => f], 64978));
    let g = [
      ...
      y = new Set(g),
      v = (t, e, i) => (i > e ? e : i < t ? t : i),
      x = { test: (t) => "number" == typeof t, parse: parseFloat, transform: (t) => t },
      w = { ...x, transform: (t) => v(0, 1, t) },
      b = { ...x, default: 1 },
      T = (t) => Math.round(1e5 * t) / 1e5,
      P = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu,
      S =
      ...
      M = { ...x, transform: (t) => Math.round(v(0, 255, t)) },
      C = {
        test: E("rgb", "red"),
      ...
      L = k("vh"),
      B = k("vw"),
      F = { ...D, parse: (t) => D.parse(t) / 100, transform: (t) => D.transform(100 * t) },
      I = {
        test: E("hsl", "hue"),
      ...
      O = {
        test: (t) => C.test(t) || V.test(t) || I.test(t),
        parse: (t) => (C.test(t) ? C.parse(t) : I.test(t) ? I.parse(t) : V.parse(t)),
        transform: (t) =>
          "string" == typeof t ? t : t.hasOwnProperty("red") ? C.transform(t) : I.transform(t),
        getAnimatableNone: (t) => {
          let e = O.parse(t);
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              O.test(t)
                ? (n.color.push(r), s.push($), i.push(O.parse(t)))
                : t.startsWith("var(")
                  ? (n.var.push(r), s.push("var"), i.push(t))
                  : (n.number.push(r), s.push(U), i.push(parseFloat(t))),
              ++r,
              "${}"
            ),
          )
    ...
    function Y(t) {
      ...
      return (t) => {
        ...
        for (let r = 0; r < n; r++)
          if (((s += e[r]), void 0 !== t[r])) {
            let e = i[r];
            e === U ? (s += T(t[r])) : e === $ ? (s += O.transform(t[r])) : (s += t[r]);
          }
        return s;
      };
    }
    let X = (t) => ("number" == typeof t ? 0 : O.test(t) ? O.getAnimatableNone(t) : t),
      K = {
        test: function (t) {
          return (
            isNaN(t) &&
            "string" == typeof t &&
            (t.match(P)?.length || 0) + (t.match(N)?.length || 0) > 0
          );
        },
        parse: H,
        createTransformer: Y,
      ...
      q = new Set(["brightness", "contrast", "saturate", "opacity"]);
    function G(t) {
    ...
    let _ = /\b([a-z-]*)\(.*?\)/gu,
      ...
      ti = (t) => te[t],
      tn = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
      ts = () => ({ x: tn(), y: tn() }),
      tr = () => ({ min: 0, max: 0 }),
      to = () => ({ x: tr(), y: tr() }),
      ta = (t) => !!(t && t.getVelocity),
      tl = new Set(["width", "height", "top", "left", "right", "bottom", ...g]),
      th = (t) => (e) => e.test(t),
      tu = [x, j, D, R, B, L, { test: (t) => "auto" === t, parse: (t) => t }],
      td = (t) => tu.find(th(t));
    var tc = t.i(47167);
    let tp = () => {},
      tm = () => {};
    tc.default;
    let tf = (t) => (e) => "string" == typeof e && e.startsWith(t),
      tg = tf("--"),
      ty = tf("var(--"),
      tv = (t) => !!ty(t) && tx.test(t.split("/*")[0].trim()),
      tx = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
    function tw(t) {
      return "string" == typeof t && t.split("/*")[0].includes("var(--");
    }
    let tb = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u,
      tT = (t) => (180 * t) / Math.PI,
      tP = (t) => tE(tT(Math.atan2(t[1], t[0]))),
      tS = {
        x: 4,
        y: 5,
        translateX: 4,
      ...
      tE = (t) => ((t %= 360) < 0 && (t += 360), t),
      tA = (t) => Math.sqrt(t[0] * t[0] + t[1] * t[1]),
      ...
      tC = {
        ...
        scaleY: tM,
        scale: (t) => (tA(t) + tM(t)) / 2,
        rotateX: (t) => tE(tT(Math.atan2(t[6], t[5]))),
        rotateY: (t) => tE(tT(Math.atan2(-t[2], t[0]))),
        rotateZ: tP,
        rotate: tP,
    ...
    let tD = (t) => t === x || t === j,
      ...
      tB = {
        ...
        x: (t, { transform: e }) => tk(e, "x"),
        y: (t, { transform: e }) => tk(e, "y"),
      };
    ...
    function tN(t, e) {
      let i = !1,
        ...
        f = () => {
          let r = tI.useManualTiming ? s.timestamp : performance.now();
          ((i = !1),
            tI.useManualTiming ||
    ...
    let {
        ...
        state: tW,
        steps: tz,
      } = tN("u" > typeof requestAnimationFrame ? requestAnimationFrame : tF, !0),
      tH = new Set(),
      tY = !1,
      tX = !1,
      tK = !1;
    function tq() {
      ...
      ((tX = !1), (tY = !1), tH.forEach((t) => t.complete(tK)), tH.clear());
    }
    function tG() {
      tH.forEach((t) => {
    ...
    class t_ {
      ...
      scheduleResolve() {
        ((this.state = "scheduled"),
          this.isAsync
            ? (tH.add(this), tY || ((tY = !0), tU.read(tG), tU.resolveKeyframes(tq)))
      ...
      cancel() {
        "scheduled" === this.state && (tH.delete(this), (this.state = "pending"));
      }
      resume() {
    ...
    function tJ(t, e) {
      let i = ti(t);
      return (tZ.has(i) || (i = K), i.getAnimatableNone ? i.getAnimatableNone(e) : void 0);
    }
    ...
    class t0 extends t_ {
      ...
      readKeyframes() {
        ...
        for (let i = 0; i < t.length; i++) {
          let n = t[i];
          if ("string" == typeof n && tv((n = n.trim()))) {
            let s = (function t(e, i, n = 1) {
              ...
              return tv(r) ? t(r, i, n + 1) : r;
            })(n, e.current);
            (void 0 !== s && (t[i] = s), i === t.length - 1 && (this.finalKeyframe = n));
          }
        }
        if ((this.resolveNoneKeyframes(), !tl.has(i) || 2 !== t.length)) return;
        let [n, s] = t,
          r = td(n),
          o = td(s);
        if (tw(n) !== tw(s) && tB[i]) {
      ...
      resolveNoneKeyframes() {
        ...
        i.length &&
          (function (t, e, i) {
            ...
            for (; s < t.length && !n; ) {
              let e = t[s];
              ("string" == typeof e && !tQ.has(e) && z(e).values.length && (n = t[s]), s++);
            }
    ...
    let t9 = t7(() => void 0 !== window.ScrollTimeline, "scrollTimeline"),
      t8 = (t) => null !== t;
    function et(t, { repeat: e, repeatType: i = "loop" }, n, s = 1) {
      let r = t.filter(t8),
    ...
    let ei = { layout: 0, mainThread: 0, waapi: 0 },
    ...
    class eh extends ee {
        ...
        ((this.animation = (function (
          ...
          (this.animation.onfinish = () => {
            if (((this.finishedTime = this.time), !s)) {
              let t = et(n, this.options, o, this.speed);
      ...
      set time(t) {
        ((this.manualStartTime = null),
          (this.finishedTime = null),
          (this.animation.currentTime = t1(t)));
      }
      get speed() {
      ...
      attachTimeline({ timeline: t, observe: e }) {
        ...
        t && t9())
          ? ((this.animation.timeline = t), tF)
          : e(this);
      }
    }
    let eu = new Set(["opacity", "clipPath", "filter", "transform"]),
      { schedule: ed } = tN(queueMicrotask, !1);
    function ec() {
      e = void 0;
    }
    let ep = {
      now: () => (
        void 0 === e &&
          ep.set(tW.isProcessing || tI.useManualTiming ? tW.timestamp : performance.now()),
        e
      ),
      set: (t) => {
    ...
    let ew = [
      ...
      eb = ["initial", ...ew];
    function eT(t) {
      return ev(t.animate) || eb.some((e) => ex(t[e]));
    }
    function eP(t) {
      return !!(eT(t) || t.variants);
    }
    let eS = { current: null },
      eE = { current: !1 },
      eA = "u" > typeof window;
    ...
    class eD {
      ...
      constructor(
        ...
        ((this.latestValues = l),
          ...
          (this.isControllingVariants = eT(e)),
        ...
        ((this.current = t),
          ...
          "never" === this.reducedMotionConfig
            ...
            : "always" === this.reducedMotionConfig
              ...
              : (eE.current || eM(), (this.shouldReduceMotion = eS.current)),
      ...
      bindToMotionValue(t, e) {
        ...
        if (
          ...
          e.accelerate && eu.has(t) && this.current instanceof HTMLElement)
        ) {
      ...
      update(t, e) {
        ...
        ((this.prevMotionValues = (function (t, e, i) {
          for (let n in e) {
            let s = e[n],
              r = i[n];
            if (ta(s)) t.addValue(n, s);
            else if (ta(r)) t.addValue(n, ef(s, { owner: t }));
            else if (r !== s)
              if (t.hasValue(n)) {
                let e = t.getValue(n);
                ...
                t.addValue(n, ef(void 0 !== e ? e : s, { owner: t }));
              }
          }
      ...
      getValue(t, e) {
        ...
        return (
          void 0 === i &&
            void 0 !== e &&
            ((i = ef(null === e ? void 0 : e, { owner: this })), this.addValue(t, i)),
          i
        );
      }
      readValue(t, e) {
        ...
        if (null != i) {
          ...
          if (
            ...
            let n;
            ((n = i), !eg.find(th(n)) && K.test(e) && (i = tJ(t, e)));
          }
          this.setBaseTarget(t, ta(i) ? i.get() : i);
        }
        return ta(i) ? i.get() : i;
      }
      setBaseTarget(t, e) {
      ...
      on(t, e) {
        return (this.events[t] || (this.events[t] = new t5()), this.events[t].add(e));
      }
      notify(t, ...e) {
    ...
    let eN = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
      eU = { offset: "strokeDashoffset", array: "strokeDasharray" },
      e$ = ["offsetDistance", "offsetPath", "offsetRotate", "offsetAnchor"];
    function eW(
      t,
      {
        attrX: e,
    ...
    let ez = new Set([
      ...
      eH = (t) => "string" == typeof t && "svg" === t.toLowerCase();
    ...
    function e_(t, { layout: e, layoutId: i }) {
      return (
        y.has(t) || t.startsWith("origin") || ((e || void 0 !== i) && (!!eG[t] || "opacity" === t))
      );
    }
    function eZ(t, e, i) {
      let n = t.style,
      ...
      if (!n) return r;
      for (let e in n)
        (ta(n[e]) || (s && ta(s[e])) || e_(e, t) || i?.getValue(e)?.liveStyle !== void 0) &&
          (r[e] = n[e]);
      return r;
    }
    function eJ(t, e, i) {
      ...
      for (let i in t)
        (ta(t[i]) || ta(e[i])) &&
          (n[-1 !== g.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
      return n;
    }
    class eQ extends ej {
      constructor() {
      ...
      readValueFromInstance(t, e) {
        ...
        return ((e = ez.has(e) ? e : eL(e)), t.getAttribute(e));
      }
      scrapeMotionValuesFromProps(t, e, i) {
        return eJ(t, e, i);
      }
      ...
      renderInstance(t, e, i, n) {
        for (let i in (eY(t, e, void 0, n), e.attrs))
          t.setAttribute(ez.has(i) ? i : eL(i), e.attrs[i]);
      }
      mount(t) {
        ((this.isSVGTag = eH(t.tagName)), super.mount(t));
      }
    }
    function e0({ top: t, left: e, right: i, bottom: n }) {
    ...
    function e2({ scale: t, scaleX: e, scaleY: i }) {
      return !e1(t) || !e1(e) || !e1(i);
    }
    function e3(t) {
      return e2(t) || e5(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
    }
    function e5(t) {
      var e, i;
      return ((e = t.x) && "0%" !== e) || ((i = t.y) && "0%" !== i);
    }
    function e4(t, e, i, n, s) {
      return (void 0 !== s && (t = n + s * (t - n)), n + i * (t - n) + e);
    }
    function e6(t, e = 0, i = 1, n, s) {
      ((t.min = e4(t.min, e, i, n, s)), (t.max = e4(t.max, e, i, n, s)));
    }
    function e7(t, { x: e, y: i }) {
      (e6(t.x, e.translate, e.scale, e.originPoint), e6(t.y, i.translate, i.scale, i.originPoint));
    }
    function e9(t, e) {
      ((t.min = t.min + e), (t.max = t.max + e));
    }
    function e8(t, e, i, n, s = 0.5) {
      let r = eq(t.min, t.max, s);
      e6(t, e, i, r, n);
    }
    function it(t, e) {
      (e8(t.x, e.x, e.scaleX, e.scale, e.originX), e8(t.y, e.y, e.scaleY, e.scale, e.originY));
    }
    function ie(t, e) {
      return e0(
        (function (t, e) {
      ...
      readValueFromInstance(t, e) {
              ...
              })(t, e);
        {
          let i = window.getComputedStyle(t),
            n = (tg(e) ? i.getPropertyValue(e) : i[e]) || 0;
    ...
    var io = t.i(43476);
    let ia = (0, o.createContext)({ strict: !1 }),
      il = (0, o.createContext)({});
    function ih(t) {
      return Array.isArray(t) ? t.join(" ") : t;
    }
    let iu = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
    function id(t, e, i) {
      for (let n in e) ta(e[n]) || e_(n, i) || (t[n] = e[n]);
    }
    let ic = () => ({ ...iu(), attrs: {} }),
      ip = new Set([
        "animate",
    ...
    try {
      ((r = (() => {
        ...
        "function" == typeof r && (ig = (t) => (t.startsWith("on") ? !im(t) : r(t))));
    } catch {}
    function iy(t) {
      return ta(t) ? t.get() : t;
    }
    let iv = (t) => (e, i) => {
        let n = (0, o.useContext)(il),
          s = (0, o.useContext)(d),
          r = () =>
      ...
      ix = iv({ scrapeMotionValuesFromProps: eZ, createRenderState: iu }),
      iw = iv({ scrapeMotionValuesFromProps: eJ, createRenderState: ic }),
      ib = {
        animation: [
          "animate",
          "variants",
    ...
    function iP() {
      return (
        !(function () {
          if (iT) return;
          let t = {};
          for (let e in ib) t[e] = { isEnabled: (t) => ib[e].some((e) => !!t[e]) };
          ((eR = t), (iT = !0));
        })(),
        eR
      );
    }
    let iS = Symbol.for("motionComponentSymbol"),
      iE = "data-" + eL("framerAppearId"),
      iA = (0, o.createContext)({});
    function iM(t) {
      return t && "object" == typeof t && Object.prototype.hasOwnProperty.call(t, "current");
    }
    function iC(t, { forwardMotionProps: e = !1, type: i } = {}, n, s) {
      n &&
        (function (t) {
          let e = iP();
      ...
      function c(i, n) {
        ...
        let p,
          ...
          x = (function (t) {
            ...
            return (0, o.useMemo)(() => ({ initial: e, animate: i }), [ih(e), ih(i)]);
          })(i),
          w = l(i, v);
        if (!v && h) {
          (0, o.useContext)(ia).strict;
          let e = (function (t) {
            let { drag: e, layout: i } = iP();
            if (!e && !i) return {};
            let n = { ...e, ...i };
            return {
          ...
          ((p = e.MeasureLayout),
            (x.visualElement = (function (t, e, i, n, s, r) {
              let { visualElement: a } = (0, o.useContext)(il),
                l = (0, o.useContext)(ia),
                h = (0, o.useContext)(d),
                c = (0, o.useContext)(m),
                p = c.reducedMotion,
            ...
            })(t, w, y, s, e.ProjectionNode, r)));
        }
        return (0, io.jsxs)(il.Provider, {
          value: x,
          children: [
            p && x.visualElement ? (0, io.jsx)(p, { visualElement: x.visualElement, ...y }) : null,
            (function (t, e, i, { latestValues: n }, s, r = !1, a) {
              let l = (
                  (a ?? ir(t))
                    ? function (t, e, i, n) {
                        let s = (0, o.useMemo)(() => {
                          let i = ic();
                          return (
                            eW(i, e, eH(n), t.transformTemplate, t.style),
                            { ...i.attrs, style: { ...i.style } }
                          );
                        }, [e]);
                        if (t.style) {
                          let e = {};
                          (id(e, t.style, t), (s.style = { ...e, ...s.style }));
                        }
                        return s;
                      }
                    : function (t, e) {
                          ...
                          r =
                            ...
                            Object.assign(
                              ...
                              (function ({ transformTemplate: t }, e) {
                                return (0, o.useMemo)(() => {
                                  let i = iu();
                                  return (eO(i, e, t), Object.assign({}, i.vars, i.style));
                                }, [e]);
                              })(t, e),
                            ),
                            n);
              ...
              (0, o.useCallback)(
                (t) => {
                  ...
                  if ("function" == typeof e)
                    if (t) {
                      let i = e(t);
                      "function" == typeof i && (g.current = i);
                    } else g.current ? (g.current(), (g.current = null)) : e(t);
                  else e && (e.current = t);
                },
                [c],
              )),
          ...
          (i = (function ({ hue: t, saturation: e, lightness: i, alpha: n }) {
            ...
            if ((e /= 100)) {
              let n = i < 0.5 ? i * (1 + e) : i + e - i * e,
                a = 2 * i - n;
              ((s = iI(a, n, t + 1 / 3)), (r = iI(a, n, t)), (o = iI(a, n, t - 1 / 3)));
            } else s = r = o = i;
            return {
    ...
    let iW = (t, e) => {
        ...
        let s = { ...i };
        return (t) => (
          (s.red = iN(i.red, n.red, t)),
          (s.green = iN(i.green, n.green, t)),
          (s.blue = iN(i.blue, n.blue, t)),
          (s.alpha = eq(i.alpha, n.alpha, t)),
          C.transform(s)
        );
      },
    ...
    let i_ = (t) => {
      ...
      return {
        ...
        stop: () => t$(e),
        now: () => (tW.isProcessing ? tW.timestamp : ep.now()),
      };
    };
    function iZ(t) {
      let e = 0,
    ...
    let i5 = ["duration", "bounce"],
      i4 = ["stiffness", "damping", "mass"];
    function i6(t, e) {
      return e.some((e) => void 0 !== t[e]);
    }
    function i7(t = 0.3, e = 0.3) {
      let i,
          ...
          if (!i6(t, i4) && i6(t, i5))
            if (((e.velocity = 0), t.visualDuration)) {
              let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                n = i * i,
                s = 2 * v(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(n);
              ...
              let i = (function ({
                ...
                ((o = v(0.05, 1, o)),
                  ...
                  o < 1
                    ? ((s = (e) => {
                        let n = e * o,
                          s = n * t;
                        return 0.001 - ((n - i) / i3(e, o)) * Math.exp(-s);
                      }),
                      (r = (e) => {
                        let n = e * o * t,
                ...
                if (((t = t1(t)), isNaN(a))) return { stiffness: 100, damping: 10, duration: t };
                {
        ...
        x = Math.sqrt(h / d) / 1e3,
        w = 5 > Math.abs(y);
      if ((s || (s = w ? iQ : i0), r || (r = w ? i1 : i2), g < 1)) {
        let t = i3(x, g);
        i = (e) =>
          a -
          Math.exp(-g * x * e) * (((f + g * x * y) / t) * Math.sin(t * e) + y * Math.cos(t * e));
      } else if (1 === g) i = (t) => a - Math.exp(-x * t) * (y + (f + x * y) * t);
      else {
        let t = x * Math.sqrt(g * g - 1);
        i = (e) => {
          let i = Math.exp(-g * x * e),
            n = Math.min(t * e, 300);
          return a - (i * ((f + g * x * y) * Math.sinh(n) + t * y * Math.cosh(n))) / t;
        };
      }
      let b = {
        ...
        toString: () => {
          let t = Math.min(iZ(b), 2e4),
            e = er((e) => b.next(t * e).value, t, 30);
          return t + "ms " + e;
        },
        toTransition: () => {},
      };
    ...
    function i9({
      ...
      return (
        b(0),
        {
          ...
          next: (t) => {
            let e = !1;
            return (c || void 0 !== d || ((e = !0), w(t), b(t)), void 0 !== d && t >= d)
              ? c.next(t - d)
              : (e || w(t), m);
          },
        }
    ...
    i7.applyToOptions = (t) => {
      ...
      return ((t.ease = e.ease), (t.duration = t1(e.duration)), (t.type = "keyframes"), t);
    };
    let i8 = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
    function nt(t, e, i, n) {
      return t === e && i === n
        ? tF
        : (s) =>
              ...
              : i8(
                  (function (t, e, i, n, s) {
                    let r,
                      o,
                      a = 0;
                    do (r = i8((o = e + (i - e) / 2), n, s) - t) > 0 ? (i = o) : (e = o);
    ...
    let ne = nt(0.42, 0, 1, 1),
      ...
      na = nr(no),
      nl = ns(na),
      nh = (t) => ((t *= 2) < 1 ? 0.5 * na(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
      ...
      nm = (t) => {
        ...
        return "string" == typeof t
          ? (tm(void 0 !== np[t], `Invalid easing type '${t}'`, "invalid-easing-type"), np[t])
          : t;
      },
      nf = (t, e, i) => {
        let n = e - t;
    ...
    function ng({ duration: t = 300, keyframes: e, times: i, ease: n = "easeInOut" }) {
      var s;
      let r,
        ...
        l = (function (t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
          ...
          let a = (function (t, e, i) {
              ...
              for (let i = 0; i < r; i++) {
                let r = s(t[i], t[i + 1]);
                (e && (r = iF(Array.isArray(e) ? e[i] || tF : e, r)), n.push(r));
              }
              return n;
            })(e, n, s),
            l = a.length,
          ...
          s.map((e) => e * t)),
          e,
          { ease: Array.isArray(o) ? o : e.map(() => o || nn).splice(0, e.length - 1) },
        );
      return { calculatedDuration: t, next: (e) => ((a.value = l(e)), (a.done = e >= t), a) };
    }
    let ny = { decay: i9, inertia: i9, tween: ng, keyframes: ng, spring: i7 };
    function nv(t) {
    ...
    class nw extends ee {
      ...
      initAnimation() {
        let { options: t } = this;
        nv(t);
        let { type: e = ng, repeat: i = 0, repeatDelay: n = 0, repeatType: s, velocity: r = 0 } = t,
          { keyframes: o } = t,
          a = e || ng;
        a !== ng &&
          "number" != typeof o[0] &&
        ...
        ("mirror" === s &&
          ...
          null === l.calculatedDuration && (l.calculatedDuration = iZ(l)));
      ...
      tick(t, e = !1) {
        ...
        if (u) {
          ...
          (!i && t >= 1 && (i = 1),
            1 === i && e--,
            (e = Math.min(e, u + 1)) % 2 &&
              ("reverse" === d ? ((i = 1 - i), c && (i -= c / o)) : "mirror" === d && (w = r)),
            (x = v(0, 1, i) * o));
        }
        let b = y ? { done: !1, value: h[0] } : w.next(x);
        s && (b.value = s(b.value));
        let { done: T } = b;
        y ||
          null === a ||
          (T = this.playbackSpeed >= 0 ? this.currentTime >= n : this.currentTime <= 0);
        let P =
          null === this.holdTime && ("finished" === this.state || ("running" === this.state && T));
        return (
          P && p !== i9 && (b.value = et(h, this.options, f, this.speed)),
          m && m(b.value),
          P && this.finish(),
          b
        );
      ...
      set speed(t) {
        this.updateTime(ep.now());
        let e = this.playbackSpeed !== t;
        ((this.playbackSpeed = t), e && (this.time = this.currentTime / 1e3));
      }
      play() {
        if (this.isStopped) return;
        let { driver: t = i_, startTime: e } = this.options;
    ...
    let nb = { anticipate: nh, backInOut: nl, circInOut: nc };
    class nT extends eh {
      constructor(t) {
        (!(function (t) {
      ...
      updateMotionValue(t) {
        ...
        let o = new nw({ ...r, autoplay: !1 }),
          a = Math.max(10, ep.now() - this.startTime),
          l = v(0, 10, a - 10);
    ...
    let nP = (t, e) =>
      ...
      !!(
        "number" == typeof t ||
        Array.isArray(t) ||
        ("string" == typeof t && (K.test(t) || "0" === t) && !t.startsWith("url("))
      );
    function nS(t) {
      ((t.duration = 0), (t.type = "keyframes"));
    }
    let nE = new Set(["opacity", "clipPath", "filter", "transform"]),
      nA = t4(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
    class nM extends ee {
      constructor({
        autoplay: t = !0,
        delay: e = 0,
      ...
      onKeyframesResolved(t, e, i, n) {
        ...
        ((this.resolvedAt = ep.now()),
          !(function (t, e, i, n) {
            ...
            ((tI.instantAnimations || !a) && h?.(et(t, i, e)),
            (t[0] = t[t.length - 1]),
            nS(i),
            (i.repeat = 0)));
        let u = {
          ...
          p = d ? new nT({ ...u, element: c }) : new nw(u);
        (p.finished
          .then(() => {
            this.notifyFinished();
          })
      ...
      get animation() {
        return (
          this._animation || (this.keyframeResolver?.resume(), (tK = !0), tG(), tq(), (tK = !1)),
          this._animation
        );
      }
      get duration() {
    ...
    let nC = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
      ...
      nD =
        ...
        (o) => {
          ...
          (!(function ({
            ...
            u.duration && (u.duration = t1(u.duration)),
            u.repeatDelay && (u.repeatDelay = t1(u.repeatDelay)),
            void 0 !== u.from && (u.keyframes[0] = u.from));
          let d = !1;
          if (
            ((!1 !== u.type && (0 !== u.duration || u.repeatDelay)) ||
              (nS(u), 0 === u.delay && (d = !0)),
            (tI.instantAnimations || tI.skipAnimations || s?.shouldSkipAnimations) &&
              ((d = !0), nS(u), (u.delay = 0)),
          ...
          return a.isSync ? new nw(u) : new nM(u);
        };
    function nj(t, e, { delay: i = 0, transitionOverride: n, type: s } = {}) {
      ...
      for (let e in a) {
        ...
        n.start(nD(e, n, s, p && tl.has(e) ? { type: !1 } : o, t, c));
        let m = n.animation;
        m && u.push(m);
      }
      if (o) {
        let e = () =>
          tU.update(() => {
            o &&
              (function (t, e) {
                let { transitionEnd: i = {}, transition: n = {}, ...s } = ik(t, e) || {};
                for (let e in (s = { ...s, ...i })) {
                  var r;
                  let i = ij((r = s[e])) ? r[r.length - 1] || 0 : r;
                  t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, ef(i));
                }
              })(t, o);
          });
    ...
    function nB(t, e, i = {}) {
      ...
      let r = n ? () => Promise.all(nj(t, n, i)) : () => Promise.resolve(),
        o =
    ...
    let nH = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
      nY = new Set(["INPUT", "SELECT", "TEXTAREA"]);
    function nX(t, e, i, n = { passive: !0 }) {
    ...
    function nG(t, e, i, n = 0.5) {
      ((t.origin = n),
        (t.originPoint = eq(e.min, e.max, t.origin)),
        (t.scale = nq(i) / nq(e)),
        (t.translate = eq(i.min, i.max, t.origin) - t.originPoint),
        ((t.scale >= 0.9999 && t.scale <= 1.0001) || isNaN(t.scale)) && (t.scale = 1),
        ((t.translate >= -0.01 && t.translate <= 0.01) || isNaN(t.translate)) && (t.translate = 0));
    }
    function n_(t, e, i, n) {
      (nG(t.x, e.x, i.x, n ? n.originX : void 0), nG(t.y, e.y, i.y, n ? n.originY : void 0));
    }
    function nZ(t, e, i) {
      ((t.min = i.min + e.min), (t.max = t.min + nq(e)));
    }
    function nJ(t, e, i) {
      ((t.min = e.min - i.min), (t.max = t.min + nq(e)));
    }
    function nQ(t, e, i) {
    ...
    let n2 = new WeakMap(),
      n3 = (t, e, i) => (n, s) =>
        s && s[0] ? s[0][t + "Size"] : n0(n) && "getBBox" in n ? n.getBBox()[e] : n[i],
      n5 = n3("inline", "width", "offsetWidth"),
      n4 = n3("block", "height", "offsetHeight");
    ...
    function n8(t, e) {
      ...
      return "function" == typeof t
        ...
        : (!i && "u" > typeof ResizeObserver && (i = new ResizeObserver(n7)),
          (s = n1(t)).forEach((t) => {
            let n = n2.get(t);
    ...
    function si(t, e, i, n) {
      return nX(t, e, (t) => st(t) && i(t, se(t)), n);
    }
    let sn = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
      ss = (t, e) => Math.abs(t - e),
      sr = new Set(["auto", "scroll"]);
    class so {
      constructor(
        t,
        e,
        ...
        if (
          ...
          (this.updatePoint = () => {
            ...
            let i = sh(this.lastMoveEventInfo, this.history),
              n = null !== this.startEvent,
              s =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(ss(t.x, e.x) ** 2 + ss(t.y, e.y) ** 2) >= this.distanceThreshold);
            if (!n && !s) return;
            let { point: r } = i,
              { timestamp: o } = tW;
        ...
        const a = sa(se(t), this.transformPagePoint),
          { point: l } = a,
          { timestamp: h } = tW;
        this.history = [{ ...l, timestamp: h }];
        const { onSessionStart: u } = e;
        (u && u(t, sh(a, this.history)),
          (this.removeListeners = iF(
            si(this.contextWindow, "pointermove", this.handlePointerMove),
            si(this.contextWindow, "pointerup", this.handlePointerUp),
            si(this.contextWindow, "pointercancel", this.handlePointerUp),
          )),
      ...
      startScrollTracking(t) {
        ...
        for (; e; ) {
          ...
          ((sr.has(t.overflowX) || sr.has(t.overflowY)) &&
      ...
      return {
        ...
        velocity: (function (t, e) {
          ...
          let i = t.length - 1,
            n = null,
            s = su(t);
          for (; i >= 0 && ((n = t[i]), !(s.timestamp - n.timestamp > t1(0.1))); ) i--;
          if (!n) return { x: 0, y: 0 };
          n === t[0] && t.length > 2 && s.timestamp - n.timestamp > 2 * t1(0.1) && (n = t[1]);
    ...
    class sg {
      ...
      start(t, { snapToCursor: e = !1, distanceThreshold: i } = {}) {
        ...
        let s = (t) => {
            (e && this.snapToCursor(se(t).point), this.stopAnimation());
          },
          r = (t, e) => {
              ...
              nz((t) => {
                ...
                if (D.test(e)) {
                  ...
                  if (i && i.layout) {
                    ...
                    n && (e = nq(n) * (parseFloat(e) / 100));
                  }
                }
                this.originPoint[t] = e;
              }),
              s && tU.update(() => s(t, e), !1, !0),
      ...
      updateAxis(t, e, i) {
        ...
        if (!i || !sv(t, n, this.currentDirection)) return;
        ...
        (this.constraints &&
          ...
          (r = (function (t, { min: e, max: i }, n) {
            return (
              void 0 !== e && t < e
                ? (t = n ? eq(e, t, n.min) : Math.max(t, e))
                : void 0 !== i && t > i && (t = n ? eq(i, t, n.max) : Math.min(t, i)),
              t
            );
        ...
        (t && iM(t)
          ...
          : t && i
            ? (this.constraints = (function (t, { top: e, left: i, bottom: n, right: s }) {
                return { x: sd(t.x, i, s), y: sd(t.y, e, n) };
              })(i.layoutBox, t))
            : (this.constraints = !1),
          (this.elastic = (function (t = 0.35) {
            return (
              !1 === t ? (t = 0) : !0 === t && (t = 0.35),
              { x: sp(t, "left", "right"), y: sp(t, "top", "bottom") }
            );
          })(e)),
          n !== this.constraints &&
            !iM(t) &&
      ...
      resolveRefConstraints() {
        ...
        let r = (function (t, e, i) {
            let n = ie(t, i),
              { scroll: s } = e;
            return (s && (e9(n.x, s.offset.x), e9(n.y, s.offset.y)), n);
          })(n, s.root, this.visualElement.getTransformPagePoint()),
          o = ((t = s.layout.layoutBox), { x: sc(t.x, r.x), y: sc(t.y, r.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
          ...
          ((this.hasMutatedConstraints = !!t), t && (o = e0(t)));
        }
        return o;
      }
      startAnimation(t) {
        ...
        return Promise.all(
          nz((o) => {
            if (!sv(o, e, this.currentDirection)) return;
            let l = (a && a[o]) || {};
            r && (l = { min: 0, max: 0 });
            let h = {
              type: "inertia",
      ...
      startAxisValueAnimation(t, e) {
        ...
        return (iL(this.visualElement, t), i.start(nD(t, i, 0, e, this.visualElement, !1)));
      }
      stopAnimation() {
      ...
      addListeners() {
        ...
        let e = this.visualElement.current,
          i = si(e, "pointerdown", (t) => {
            let { drag: i, dragListener: n = !0 } = this.getProps(),
              s = t.target,
              r = s !== e && (nY.has(s.tagName) || !0 === s.isContentEditable);
            i && n && !r && this.start(t);
          }),
          n = () => {
            var i, n, s;
            ...
            iM(a) &&
              ...
              t ||
                ((i = e),
                (n = a.current),
                (r = n8(i, sy((s = () => this.scalePositionWithinConstraints())))),
                (o = n8(n, sy(s))),
                (t = () => {
                  (r(), o());
                })));
        ...
        (s && !s.layout && (s.root && s.root.updateScroll(), s.updateLayout()), tU.read(n));
        let o = nX(window, "resize", () => this.scalePositionWithinConstraints()),
    ...
    let sx = (t) => (e, i) => {
        t && tU.update(() => t(e, i), !1, !0);
      },
      sw = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
    var sb = o;
    let sT = !1;
    class sP extends sb.Component {
      componentDidMount() {
    ...
    function sS(t) {
      ...
      return (0, io.jsx)(sP, {
        ...t,
        layoutGroup: n,
        switchLayoutGroup: (0, sb.useContext)(iA),
        isPresent: e,
        safeToRemove: i,
      });
    }
    ...
    function sI(t, e, [i, n, s], r, o) {
      !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
        if (
          (D.test(e) && ((e = parseFloat(e)), (e = eq(o.min, o.max, e / 100) - o.min)),
          "number" != typeof e)
        )
          return;
        let a = eq(r.min, r.max, n);
        (t === r && (a -= e), (t.min = sF(t.min, e, i, a, s)), (t.max = sF(t.max, e, i, a, s)));
      })(t, e[i], e[n], e[s], e.scale, r, o);
    }
    let sO = ["x", "scaleX", "originX"],
      sN = ["y", "scaleY", "originY"];
    function sU(t, e, i, n) {
      (sI(t.x, e, sO, i ? i.x : void 0, n ? n.x : void 0),
        sI(t.y, e, sN, i ? i.y : void 0, n ? n.y : void 0));
    }
    function s$(t) {
    ...
    class sq {
      ...
      add(t) {
        ...
        for (let e = this.members.length - 1; e >= 0; e--) {
          ...
          let n = i.instance;
          n && !1 === n.isConnected && !1 !== i.isPresent && !i.snapshot && t3(this.members, i);
        }
        t.scheduleRender();
      }
      remove(t) {
        if (
          (t3(this.members, t), t === this.prevLead && (this.prevLead = void 0), t === this.lead)
        ) {
      ...
      relegate(t) {
        ...
        for (let t = i; t >= 0; t--) {
          let i = this.members[t],
            n = i.instance;
          if (!1 !== i.isPresent && (!n || !1 !== n.isConnected)) {
            e = i;
            break;
          }
        }
      ...
      promote(t, e) {
        ...
        if (t !== i && ((this.prevLead = i), (this.lead = t), t.show(), i)) {
          ...
          if (void 0 === n || void 0 === s || n !== s) {
            let n = i.instance;
            !(n && !1 === n.isConnected && !i.snapshot) &&
              ((t.resumeFrom = i),
    ...
    function s0({
      ...
      return class {
        ...
        mount(e) {
          ...
          ((this.isSVG = n0(e) && !(n0(e) && "svg" === e.tagName)), (this.instance = e));
              ...
              t(e, () => {
                ...
                if (t !== n) {
                  ...
                  ((n = t),
                    ...
                    tU.setup(r, !0),
                    (i = () => t$(r)),
                    sw.hasAnimatedSinceResize &&
                      ((sw.hasAnimatedSinceResize = !1), this.nodes.forEach(s8)));
                }
              }));
          }
              ...
              this.addEventListener(
                ...
                ({ delta: t, hasLayoutChanged: e, hasRelativeLayoutChanged: i, layout: n }) => {
                  ...
                  if (
                    ...
                    let e = { ...iD(r, "layout"), onPlay: o, onComplete: a };
        ...
        update() {
          if (((this.updateScheduled = !1), this.isUpdateBlocked())) {
            (this.unblockUpdate(), this.clearAllSnapshots(), this.nodes.forEach(s6));
            return;
          }
          if (this.animationId <= this.animationCommitId) return void this.nodes.forEach(s7);
          ...
          let t = ep.now();
          ((tW.delta = v(0, 1e3 / 60, t - tW.timestamp)),
            (tW.timestamp = t),
            (tW.isProcessing = !0),
            tz.update.process(tW),
            tz.preRender.process(tW),
            tz.render.process(tW),
            (tW.isProcessing = !1));
        }
        didUpdate() {
        ...
        clearAllSnapshots() {
          (this.nodes.forEach(s4), this.sharedNodes.forEach(rn));
        }
        ...
        updateSnapshot() {
          !this.snapshot &&
            ...
            !this.snapshot ||
              nq(this.snapshot.measuredBox.x) ||
              nq(this.snapshot.measuredBox.y) ||
        ...
        removeElementScroll(t) {
          ...
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sL(e, t), e9(e.x, s.offset.x), e9(e.y, s.offset.y));
          }
          return e;
        }
        applyTransform(t, e = !1) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            (!e &&
              ...
              n.scroll &&
              n !== n.root &&
              it(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
              e3(n.latestValues) && it(i, n.latestValues));
          }
          return (e3(this.latestValues) && it(i, this.latestValues), i);
        }
        removeTransform(t) {
          let e = to();
          sL(e, t);
          for (let t = 0; t < this.path.length; t++) {
            let i = this.path[t];
            if (!i.instance || !e3(i.latestValues)) continue;
            e2(i.latestValues) && i.updateSnapshot();
            let n = to();
            (sL(n, i.measurePageBox()),
              sU(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, n));
          }
          return (e3(this.latestValues) && sU(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
        ...
        resolveTargetDelta(t = !1) {
          ...
          if (
            ...
            if (
              (this.target || ((this.target = to()), (this.targetWithTransforms = to())),
              this.relativeTarget &&
              ...
              this.targetDelta
                ? (this.resumingFrom
                  ...
                  e7(this.target, this.targetDelta))
                : sL(this.target, this.layout.layoutBox);
            this.attemptToResolveRelativeTarget &&
        ...
        getClosestProjectingParent() {
          if (!(!this.parent || e2(this.parent.latestValues) || e5(this.parent.latestValues)))
        ...
        calcProjection() {
          ...
          (!(function (t, e, i, n = !1) {
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o || !o.props.style || "contents" !== o.props.style.display) &&
                  (n &&
                    ...
                    s.scroll &&
                    s !== s.root &&
                    it(t, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), e7(t, r)),
                  n && e3(s.latestValues) && it(t, s.latestValues));
              }
            ...
            t.layout &&
              ...
              ((t.target = t.layout.layoutBox), (t.targetWithTransforms = to())));
          let { target: a } = t;
          if (!a) {
          ...
          (this.projectionDelta && this.prevProjectionDelta
            ...
            n_(this.projectionDelta, this.layoutCorrected, a, this.latestValues),
            (this.treeScale.x === r &&
              this.treeScale.y === o &&
          ...
          ((this.animationProgress = 0),
            (this.mixTargetDelta = (e) => {
              ...
              if (
                ...
                var h, c, p, m, f, g;
                (nQ(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                  ...
                  rr(p.y, m.y, f.y, g),
                  i &&
                    ((h = this.relativeTarget), (c = i), sz(h.x, c.x) && sz(h.y, c.y)) &&
                    (this.isProjectionDirty = !1),
                  i || (i = to()),
              ...
              (l &&
                ...
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = eq(0, i.opacity ?? 1, sk(n))),
                      (t.opacityExit = eq(e.opacity ?? 1, 0, sR(n))))
                    : r && (t.opacity = eq(e.opacity ?? 1, i.opacity ?? 1, n));
                  for (let s = 0; s < sA; s++) {
                    ...
                    (void 0 !== o || void 0 !== a) &&
                      ...
                      a || (a = 0),
                      0 === o || 0 === a || sC(o) === sC(a)
                        ? ((t[r] = Math.max(eq(sM(o), sM(a), n), 0)),
                          (D.test(a) || D.test(o)) && (t[r] += "%"))
                        : (t[r] = a));
                  }
                  (e.rotate || i.rotate) && (t.rotate = eq(e.rotate || 0, i.rotate || 0, n));
        ...
        startAnimation(t) {
          (this.notifyListeners("animationStart"),
            ...
            (this.pendingAnimation = tU.update(() => {
              var e, i, n;
              let s;
              ((sw.hasAnimatedSinceResize = !0),
                ei.layout++,
                this.motionValue || (this.motionValue = ef(0)),
                ...
                (this.currentAnimation =
                  ...
                  (n = {
                    ...
                    onComplete: () => {
                      (ei.layout--, t.onComplete && t.onComplete(), this.completeAnimation());
                    },
                  }),
                  (s = ta(e) ? e : ef(e)).start(nD("", s, i, n)),
                  s.animation)),
        ...
        applyTransformsToTarget() {
          ...
          if (e && i && n) {
            if (
              ...
              i = this.target || to();
              let e = nq(this.layout.layoutBox.x);
              ((i.x.min = t.target.x.min), (i.x.max = i.x.min + e));
              let n = nq(this.layout.layoutBox.y);
              ((i.y.min = t.target.y.min), (i.y.max = i.y.min + n));
            }
            (sL(e, i), it(e, s), n_(this.projectionDeltaWithTransform, this.layoutCorrected, e, s));
          }
        }
        ...
        resetSkewAndRotation() {
          ...
          if (
            ...
            return;
          let n = {};
          i.z && sQ("z", t, n, this.animationValues);
          for (let e = 0; e < sZ.length; e++)
            (sQ(`rotate${sZ[e]}`, t, n, this.animationValues),
              sQ(`skew${sZ[e]}`, t, n, this.animationValues));
        ...
        applyProjectionStyles(t, e) {
          ...
          this.options.layoutId &&
            (t.pointerEvents = n === this ? iy(e?.pointerEvents) || "" : "none");
        }
        clearSnapshot() {
    ...
    function s2(t) {
      ...
      if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
        ...
        n_(o, i, e.layoutBox);
        let a = ts();
        r ? n_(a, t.applyTransform(n, !0), e.measuredBox) : n_(a, i, e.layoutBox);
        let l = !sW(o),
          h = !1;
        if (!t.resumeFrom) {
    ...
    function rs(t, e, i) {
      ((t.translate = eq(e.translate, 0, i)),
        (t.scale = eq(e.scale, 1, i)),
        (t.origin = e.origin),
        (t.originPoint = e.originPoint));
    }
    function rr(t, e, i, n) {
      ((t.min = eq(e.min, i.min, n)), (t.max = eq(e.max, i.max, n)));
    }
    function ro(t) {
    ...
    let ra = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      ...
      rh = rl("applewebkit/") && !rl("chrome/") ? Math.round : tF;
    function ru(t) {
      ((t.min = rh(t.min)), (t.max = rh(t.max)));
    }
    function rd(t, e, i) {
      return "position" === t || ("preserve-aspect" === t && !(0.2 >= Math.abs(sX(e) - sX(i))));
    }
    function rc(t) {
    ...
    function ry(t, e, i) {
      ...
      let s = n["onHover" + i];
      s && tU.postRender(() => s(e, se(e)));
    }
    let rv = (t, e) => !!e && (t === e || rv(t, e.parentElement)),
      rx = new WeakSet();
    function rw(t) {
      return (e) => {
        "Enter" === e.key && t(e);
    ...
    let rE = new WeakMap(),
      ...
      rk = (function (t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            "create" === r ? n : (i.has(r) || i.set(r, iC(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          animation: {
            Feature: class extends iV {
              constructor(t) {
                (super(t),
                  t.animationState ||
                    (t.animationState = (function (t) {
                      let e = (e) =>
                            ...
                            e.map(({ animation: e, options: i }) =>
                              (function (t, e, i = {}) {
                                ...
                                if ((t.notify("AnimationStart", e), Array.isArray(e)))
                                  ...
                                  let s = "function" == typeof e ? ik(t, e, i.custom) : e;
                                  n = Promise.all(nj(t, s, i));
                                }
                                return n.then(() => {
                        ...
                        n = !0,
                        s = (e) => (i, n) => {
                          let s = ik(t, n, "exit" === e ? t.presenceContext?.custom : void 0);
                          if (s) {
                      ...
                      function r(r) {
                        ...
                        for (let e = 0; e < nN; e++) {
                          ...
                          if ("exit" === m && f.isActive && !0 !== v) {
                            f.prevResolvedValues && (u = { ...u, ...f.prevResolvedValues });
                            continue;
                          }
                          let w =
                              ((c = f.prevProp),
                              ...
                              ...P.map((e) => {
                                ...
                                if (
                                  ...
                                  if (n.enteringChildren && s) {
                                    ...
                                    i.delay = nL(n.enteringChildren, t, e);
                                  }
                                }
                        ...
                        if (h.size) {
                          ...
                          if ("boolean" != typeof o.initial) {
                            let i = ik(t, Array.isArray(o.initial) ? o.initial[0] : o.initial);
                ...
                this.unmount = (function (t, e, i = {}) {
                  let [n, s, r] = rg(t, i),
                    o = (t) => {
                      ...
                      if (!rT(t) || rP.has(t)) return;
                      (rx.add(n), i.stopPropagation && rP.add(t));
                      let r = e(n, t),
                        o = (t, e) => {
                          (window.removeEventListener("pointerup", a),
                            window.removeEventListener("pointercancel", l),
                            rx.has(n) && rx.delete(n),
                            rT(t) && "function" == typeof r && r(t, { success: e }));
                        },
                        a = (t) => {
                          o(
                            t,
                            n === window || n === document || i.useGlobalTarget || rv(n, t.target),
                          );
                        },
                        l = (t) => {
                          o(t, !1);
                  ...
                  (t, e) => (
                    ...
                    (t, { success: e }) => rS(this.node, t, e ? "End" : "Cancel")
                  ),
          ...
          focus: {
            Feature: class extends iV {
              ...
              mount() {
                this.unmount = iF(
                  nX(this.node.current, "focus", () => this.onFocus()),
                  nX(this.node.current, "blur", () => this.onBlur()),
                );
              }
              unmount() {}
            },
            ...
            Feature: class extends iV {
              mount() {
                ...
                t &&
                    ...
                    return (
                      n.forEach((t) => {
                        ...
                        (t.addEventListener(
                          "pointerenter",
                          (n) => {
                            if ("touch" === n.pointerType || nK.x || nK.y) return;
                            r = !1;
                            let o = e(t, n);
                            "function" == typeof o &&
                  ...
                  })(t, (t, e) => (ry(this.node, e, "Start"), (t) => ry(this.node, t, "End"))));
              }
              unmount() {}
            },
          },
          pan: {
            Feature: class extends iV {
              ...
              mount() {
                this.removePointerDownListener = si(this.node.current, "pointerdown", (t) =>
          ...
          layout: { ProjectionNode: rf, MeasureLayout: sS },
        },
        (t, e) =>
          (e.isSVG ?? ir(t)) ? new eQ(e) : new ii(e, { allowProjection: t !== o.Fragment }),
      );
    function rR() {
      eE.current || eM();
      let [t] = (0, o.useState)(eS.current);
      return t;
    }
    (t.s(["motion", () => rk], 78481), t.s(["useReducedMotion", () => rR], 72328));
  },
  30845,
  (t) => {
    "use strict";
    ...
    function a(t) {
      ...
      S[0] !== A
        ? ((a = (t) => ({
            initial: A ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 },
            animate: { opacity: 1, y: 0 },
            transition: { duration: 0.4, ease: "easeOut", delay: void 0 === t ? 0 : t },
          })),
          (S[0] = A),
          (S[1] = a))
        : (a = S[1]);
      ...
      S[2] !== A
        ? ((l = (t) => ({
            initial: A ? { opacity: 1 } : { opacity: 0 },
            animate: { opacity: 1 },
            transition: { duration: 0.6, ease: "easeOut", delay: void 0 === t ? 0 : t },
          })),
          (S[2] = A),
          (S[3] = l))
        : (l = S[3]);
      ...
      return (
        ...
        S[10] !== M
          ? ((c = (0, e.jsx)(r.motion.p, {
            ...
            (S[11] = c))
          : (c = S[11]),
        S[12] !== M ? ((p = M(0.24)), (S[12] = M), (S[13] = p)) : (p = S[13]),
        ...
        S[16] !== p
          ? ((g = (0, e.jsxs)(r.motion.div, {
            ...
            (S[17] = g))
          : (g = S[17]),
        S[18] !== g || S[19] !== h || S[20] !== u || S[21] !== d || S[22] !== c
          ? ((y = (0, e.jsxs)("div", {
            ...
            (S[23] = y))
          : (y = S[23]),
        S[24] !== C ? ((v = C(0.3)), (S[24] = C), (S[25] = v)) : (v = S[25]),
        S[26] !== E
          ? ((x = E
              ? (0, e.jsxs)(e.Fragment, {
                  children: [
                    (0, e.jsx)("img", {
                      src: (0, o.proxyImageUrlIfNeeded)(E),
                      alt: "",
  ...
  (t) => {
      ...
      getSnapshotBeforeUpdate(t) {
        ...
        if (e && t.isPresent && !this.props.isPresent && !1 !== this.props.pop) {
          let t = e.offsetParent,
            i = ((0, h.isHTMLElement)(t) && t.offsetWidth) || 0,
            n = ((0, h.isHTMLElement)(t) && t.offsetHeight) || 0,
    ...
    function m({ children: t, isPresent: i, anchorX: n, anchorY: r, root: o, pop: a }) {
      let l = (0, u.useId)(),
        h = (0, u.useRef)(null),
        m = (0, u.useRef)({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0 }),
        { nonce: f } = (0, u.useContext)(d.MotionConfigContext),
        g = (function (...t) {
      ...
      return (
        (0, u.useInsertionEffect)(() => {
          let { width: t, height: e, top: s, left: u, right: d, bottom: c } = m.current;
          if (i || !1 === a || !h.current || !t || !e) return;
          let p = "left" === n ? `left: ${u}` : `right: ${d}`,
            g = "bottom" === r ? `bottom: ${c}` : `top: ${s}`;
        ...
        (0, e.jsx)(p, {
          ...
          sizeRef: m,
          pop: a,
          children: !1 === a ? t : u.cloneElement(t, { ref: g }),
        })
      );
    }
    let f = ({
      ...
      return (
        ...
        (0, e.jsx)(l.PresenceContext.Provider, { value: x, children: t })
      );
    };
    function g() {
      return new Map();
    ...
    let w = ({
      ...
      let [g, w] = (0, y.usePresence)(d),
        b = (0, s.useMemo)(() => x(t), [t]),
        T = d && !g ? [] : b.map(v),
        P = (0, s.useRef)(!0),
        S = (0, s.useRef)(b),
        E = (0, o.useConstant)(() => new Map()),
      ...
      (0, a.useIsomorphicLayoutEffect)(() => {
        ...
        for (let t = 0; t < V.length; t++) {
          let e = v(V[t]);
          T.includes(e) ? (E.delete(e), A.current.delete(e)) : !0 !== E.get(e) && E.set(e, !1);
        }
      }, [V, T.length, T.join("-")]);
      let R = [];
      if (b !== M) {
        ...
        return ("wait" === u && R.length && (t = R), k(x(t)), C(b), null);
      }
      let { forceRender: D } = (0, s.useContext)(r.LayoutGroupContext);
      return (0, e.jsx)(e.Fragment, {
        children: V.map((t) => {
          let s = v(t),
            r = (!d || !!g) && (b === V || T.includes(s));
          return (0, e.jsx)(
            f,
            {
              isPresent: r,
              ...
              onExitComplete: r
                ? void 0
                : () => {
                    if (A.current.has(s) || (A.current.add(s), !E.has(s))) return;
                    E.set(s, !0);
                    let t = !0;
                    (E.forEach((e) => {
                      e || (t = !1);
                    }),
                      t && (D?.(), k(S.current), d && w?.(), l && l()));
                  },
              anchorX: c,
              anchorY: p,
              children: t,
    ...
    function E(t) {
      let r,
        ...
        p,
        m = (0, i.c)(18),
        { slug: f, title: g, featuredImageUrl: y, description: v } = t,
        [x, E] = (0, s.useState)(!1),
        A = (0, T.useReducedMotion)();
      m[0] !== v
        ? ((r = v
            ? v
                .replace(/[#*`_[\]]/g, "")
                .slice(0, 120)
                .trimEnd() + (v.length > 120 ? "…" : "")
            : null),
          (m[0] = v),
          (m[1] = r))
        : (r = m[1]);
      ...
      return (
        m[2] === Symbol.for("react.memo_cache_sentinel")
          ? ((o = (0, S.cn)(
            ...
            (m[5] = h),
            (m[6] = u))
          : ((o = m[2]), (a = m[3]), (l = m[4]), (h = m[5]), (u = m[6])),
        m[7] !== M || m[8] !== y || m[9] !== x || m[10] !== A
          ? ((d = (0, e.jsx)("div", {
              ...
              children: y
                ? (0, e.jsxs)(e.Fragment, {
                    children: [
                      (0, e.jsx)("img", {
                        src: (0, P.proxyImageUrlIfNeeded)(y),
                        alt: "",
                        className:
                      ...
                      M &&
                        (0, e.jsx)(w, {
                          children:
                            x &&
                            (0, e.jsx)(b.motion.div, {
                              className:
                                "absolute inset-x-0 bottom-0 top-auto bg-[var(--p-deep-walnut)]/90 px-5 py-4",
                              initial: A ? { opacity: 1, y: 0 } : { opacity: 0, y: "100%" },
                              animate: { opacity: 1, y: 0 },
                              exit: A ? { opacity: 1, y: 0 } : { opacity: 0, y: "100%" },
        ...
        m[12] !== g
          ? ((c = (0, e.jsx)("div", {
            ...
            (m[13] = c))
          : (c = m[13]),
        m[14] !== C || m[15] !== d || m[16] !== c
          ? ((p = (0, e.jsxs)(n.default, {
              href: C,
              className: o,
              onMouseEnter: a,
              onMouseLeave: l,
