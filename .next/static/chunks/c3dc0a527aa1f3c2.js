        ...
        createResult(e, t) {
          ...
          if (t._optimisticResults) {
            let r = this.hasListeners(),
              n = !r && c(e, t),
              l = r && d(e, s, t, a);
            ((n || l) && (g = { ...g, ...(0, i.fetchState)(m.data, e.options) }),
              "isRestoring" === t._optimisticResults && (g.fetchStatus = "idle"));
          }
          let { error: v, errorUpdatedAt: y, status: x } = g;
          r = g.data;
          let R = !1;
            ...
            (o?.isPlaceholderData && t.placeholderData === h?.placeholderData
              ...
              : (e =
                  "function" == typeof t.placeholderData
                    ...
                    : t.placeholderData),
              void 0 !== e && ((x = "success"), (r = (0, l.replaceData)(o?.data, e, t)), (b = !0)));
          }
          if (t.select && void 0 !== r && !R)
            if (o && r === u?.data && t.select === this.#o) r = this.#u;
            else
              try {
                ((this.#o = t.select),
                  (r = t.select(r)),
          ...
          this.#t && ((v = this.#t), (r = this.#u), (y = Date.now()), (x = "error"));
          let j = "fetching" === g.fetchStatus,
            w = "pending" === x,
            S = "error" === x,
            I = w && j,
            U = void 0 !== r,
    ...
    function y(e, t) {
      return (function (e, t, r) {
        let i,
          a = f.useContext(b),
          n = f.useContext(g),
          o = (0, m.useQueryClient)(r),
          u = o.defaultQueryOptions(e);
        o.getDefaultOptions().queries?._experimental_beforeQuery?.(u);
        let c = o.getQueryCache().get(u.queryHash);
        ...
        let h = !o.getQueryCache().get(u.queryHash),
          [d] = f.useState(() => new t(o, u)),
        ...
        if (
          ...
          throw p.error;
        if (
          (o.getDefaultOptions().queries?._experimental_afterQuery?.(u, p),
          u.experimental_prefetchInRender && !l.isServer && p.isLoading && p.isFetching && !a)
        ) {
  ...
  (e) => {
    ...
    var t = e.i(71645),
      ...
      n = class extends i.Subscribable {
        ...
        #I;
        constructor(e, t) {
          (super(), (this.#e = e), this.setOptions(t), this.bindMethods(), this.#U());
        }
        bindMethods() {
        ...
        reset() {
          (this.#S?.removeObserver(this), (this.#S = void 0), this.#U(), this.#w());
        }
        mutate(e, t) {
          return (
            (this.#I = t),
      ...
      l = e.i(12598);
    function o(e, r) {
      let i = (0, l.useQueryClient)(r),
        [o] = t.useState(() => new n(i, e));
      t.useEffect(() => {
        o.setOptions(e);
      }, [o, e]);
      let u = t.useSyncExternalStore(
          t.useCallback((e) => o.subscribe(s.notifyManager.batchCalls(e)), [o]),
          () => o.getCurrentResult(),
          () => o.getCurrentResult(),
        ),
        c = t.useCallback(
          (e, t) => {
            o.mutate(e, t).catch(a.noop);
          },
          [o],
        );
      if (u.error && (0, a.shouldThrowError)(o.options.throwOnError, [u.error])) throw u.error;
      return { ...u, mutate: c, mutateAsync: u.mutate };
    }
    e.s(["useMutation", () => o], 54616);
    var u = e.i(43476),
      c = e.i(46696),
      h = e.i(23426),
      d = e.i(75157);
      ...
      let n = (0, t.useRef)(null),
        ...
        v = (0, t.useCallback)(
          async (t) => {
            ...
            if (0 !== i.length) {
              if (!s && i.length > 1) return void c.toast.error("Only one image allowed here.");
              (m(!0), b(i.length));
              try {
                let t = await p(i);
                r(s ? [...e, ...t] : t);
                ...
                (m(!1), b(0), n.current && (n.current.value = ""));
              }
            }
          },
          [s, r, e],
        ...
        y = (0, t.useCallback)(
          (e) => {
            (e.preventDefault(), o(!1), a || f || v(e.dataTransfer.files));
          },
          [a, v, f],
        ),
        x = s || 0 === e.length;
  ...
  (e) => {
    ...
    function f(e, t, r = []) {
      if ("slug" === e) {
        ...
        if (!d.test(t)) return "Slug must be lowercase letters, numbers, and hyphens only";
    ...
    function v(e) {
      let o,
        ...
        eC,
        eQ = (0, r.c)(133),
        { mode: eE, id: eT, initialData: ek } = e,
        eN = (0, i.useRouter)(),
        [e_, eM] = (0, s.useState)(ek ?? h);
      eQ[0] === Symbol.for("react.memo_cache_sentinel") ? ((o = {}), (eQ[0] = o)) : (o = eQ[0]);
      let [eP, eD] = (0, s.useState)(o),
        eF = (0, s.useRef)(!!ek?.slug),
        eL = (0, s.useRef)(null);
      eQ[1] === Symbol.for("react.memo_cache_sentinel")
        ? ((c = { queryKey: ["projects", "admin"], queryFn: E }), (eQ[1] = c))
        : (c = eQ[1]);
      let { data: eq } = (0, n.useQuery)(c);
      eQ[2] !== eT || eQ[3] !== eE || eQ[4] !== eq
        ? ((d =
            "create" === eE ? (eq?.map(Q) ?? []) : (eq?.filter((e) => e.id !== eT).map(C) ?? [])),
          (eQ[2] = eT),
          (eQ[3] = eE),
          (eQ[4] = eq),
          (eQ[5] = d))
      ...
      eQ[6] !== eN
        ? ((v = {
            mutationFn: O,
            onSuccess: () => {
              (l.toast.success("Project created"), eN.push("/cms/projects"));
            },
            onError: U,
          }),
          (eQ[6] = eN),
          (eQ[7] = v))
        : (v = eQ[7]);
      let eK = (0, a.useMutation)(v);
      eQ[8] !== eN
        ? ((T = {
            mutationFn: I,
            onSuccess: () => {
              (l.toast.success("Project updated"), eN.push("/cms/projects"));
            },
            onError: S,
          }),
          (eQ[8] = eN),
          (eQ[9] = T))
        : (T = eQ[9]);
      let eW = (0, a.useMutation)(T),
        ez = eK.isPending || eW.isPending;
      eQ[10] !== eA || eQ[11] !== e_
        ? ((k = (e) => {
            let t = f(e, e_[e], eA);
            eD((r) => ({ ...r, [e]: t }));
        ...
        : (k = eQ[12]);
      let eB = k;
      eQ[13] !== eP.slug || eQ[14] !== eP.title
        ? ((N = function (e) {
            let t = e.target.value;
            (eM((e) => ({ ...e, title: t, slug: eF.current ? e.slug : p(t) })),
              eP.title && eD(w),
              !eF.current && eP.slug && eD(j));
          }),
          (eQ[13] = eP.slug),
          (eQ[14] = eP.title),
          (eQ[15] = N))
      ...
      eQ[16] !== eP.slug
        ? ((_ = function (e) {
            let t = e.target.value,
              r = p(t) || t.replace(/[^a-z0-9-]/gi, "").toLowerCase();
            ((eF.current = !0), eM((e) => ({ ...e, slug: r })), eP.slug && eD(R));
          }),
          (eQ[16] = eP.slug),
          (eQ[17] = _))
        : (_ = eQ[17]);
      ...
      eQ[23] !== e_
        ? ((M = function (e) {
            ...
            if ((eD(t), Object.keys(t).length > 0))
            ...
            let r = {
              ...
              featuredImageUrl: e_.featuredImageUrl.trim() || null,
              published: e_.published,
              imageUrls: e_.imageUrls.filter(Boolean),
            };
            "create" === eE ? eK.mutate(r) : eT && eW.mutate({ id: eT, ...r });
          }),
          (eQ[18] = eK),
          (eQ[19] = eA),
          (eQ[20] = eT),
        ...
        : (M = eQ[24]);
      let eH = M;
      (eQ[25] === Symbol.for("react.memo_cache_sentinel")
        ? ((P = (0, t.jsx)("legend", {
          ...
          (eQ[25] = P))
        : (P = eQ[25]),
        eQ[26] === Symbol.for("react.memo_cache_sentinel")
          ? ((D = (0, t.jsxs)("label", {
              htmlFor: "title",
              className: m,
              children: [
            ...
            (eQ[26] = D))
          : (D = eQ[26]),
        eQ[27] !== eP.slug || eQ[28] !== eP.title
          ? ((F = (e) => {
              eP.title && !eP.slug && (eL.current = e);
            }),
            (eQ[27] = eP.slug),
            (eQ[28] = eP.title),
            (eQ[29] = F))
          : (F = eQ[29]));
      let eV = !!eP.title;
      (eQ[30] !== eV ? ((L = g(eV)), (eQ[30] = eV), (eQ[31] = L)) : (L = eQ[31]),
        eQ[32] !== eB ? ((q = () => eB("title")), (eQ[32] = eB), (eQ[33] = q)) : (q = eQ[33]),
        eQ[34] !== e$ || eQ[35] !== F || eQ[36] !== L || eQ[37] !== q || eQ[38] !== e_.title
          ? ((A = (0, t.jsx)("input", {
              id: "title",
              ref: F,
              className: L,
          ...
          : (A = eQ[39]),
        eQ[40] !== eP.title
          ? ((K = (0, t.jsx)(b, { message: eP.title })), (eQ[40] = eP.title), (eQ[41] = K))
          : (K = eQ[41]),
        eQ[42] !== A || eQ[43] !== K
          ? ((W = (0, t.jsxs)("div", { className: "space-y-1.5", children: [D, A, K] })),
            (eQ[42] = A),
            (eQ[43] = K),
            (eQ[44] = W))
          : (W = eQ[44]),
        eQ[45] === Symbol.for("react.memo_cache_sentinel")
          ? ((z = (0, t.jsxs)("label", {
              htmlFor: "slug",
              className: m,
        ...
        eQ[46] !== eP.slug
          ? ((B = (e) => {
              eP.slug && (eL.current = e);
            }),
            (eQ[46] = eP.slug),
            (eQ[47] = B))
          : (B = eQ[47]));
      let eJ = !!eP.slug;
      (eQ[48] !== eJ ? (($ = g(eJ)), (eQ[48] = eJ), (eQ[49] = $)) : ($ = eQ[49]),
        eQ[50] !== eB ? ((G = () => eB("slug")), (eQ[50] = eB), (eQ[51] = G)) : (G = eQ[51]),
        eQ[52] !== eG || eQ[53] !== B || eQ[54] !== $ || eQ[55] !== G || eQ[56] !== e_.slug
          ? ((H = (0, t.jsx)("input", {
              id: "slug",
              ref: B,
              className: $,
            ...
            (eQ[57] = H))
          : (H = eQ[57]),
        eQ[58] === Symbol.for("react.memo_cache_sentinel")
          ? ((V = (0, t.jsxs)("p", {
          ...
          : (V = eQ[58]),
        eQ[59] !== eP.slug
          ? ((J = (0, t.jsx)(b, { message: eP.slug })), (eQ[59] = eP.slug), (eQ[60] = J))
          : (J = eQ[60]),
        eQ[61] !== H || eQ[62] !== J
          ? ((Z = (0, t.jsxs)("div", { className: "space-y-1.5", children: [z, H, V, J] })),
            (eQ[61] = H),
            (eQ[62] = J),
            (eQ[63] = Z))
          : (Z = eQ[63]),
        eQ[64] === Symbol.for("react.memo_cache_sentinel")
          ? ((X = (0, t.jsx)("label", {
              htmlFor: "description",
              className: m,
            ...
            (eQ[64] = X))
          : (X = eQ[64]),
        eQ[65] === Symbol.for("react.memo_cache_sentinel")
          ? ((Y = (e) => eM((t) => ({ ...t, description: e.target.value }))), (eQ[65] = Y))
          : (Y = eQ[65]),
        eQ[66] !== e_.description
          ? ((ee = (0, t.jsxs)("div", {
        ...
        eQ[68] !== W || eQ[69] !== Z || eQ[70] !== ee
          ? ((et = (0, t.jsxs)("fieldset", {
            ...
            (eQ[71] = et))
          : (et = eQ[71]),
        eQ[72] === Symbol.for("react.memo_cache_sentinel")
          ? ((er = (0, t.jsx)("legend", {
              className:
            ...
            (eQ[73] = es))
          : ((er = eQ[72]), (es = eQ[73])),
        eQ[74] !== e_.featuredImageUrl
          ? ((ei = e_.featuredImageUrl ? [e_.featuredImageUrl] : []),
            (eQ[74] = e_.featuredImageUrl),
            (eQ[75] = ei))
          : (ei = eQ[75]),
        eQ[76] === Symbol.for("react.memo_cache_sentinel")
          ? ((ea = (e) => {
              (eM((t) => ({ ...t, featuredImageUrl: e[0] ?? "" })), eD(x));
            }),
            (eQ[76] = ea))
          : (ea = eQ[76]),
        eQ[77] !== ez || eQ[78] !== ei
          ? ((en = (0, t.jsx)(u.ImageUploader, {
              multiple: !1,
              value: ei,
              onChange: ea,
              disabled: ez,
            ...
            (eQ[79] = en))
          : (en = eQ[79]),
        eQ[80] === Symbol.for("react.memo_cache_sentinel")
          ? ((el = (0, t.jsx)("label", {
            ...
            (eQ[80] = el))
          : (el = eQ[80]),
        eQ[81] !== eP.featuredImageUrl || eQ[82] !== eP.slug || eQ[83] !== eP.title
          ? ((eo = (e) => {
              !eP.featuredImageUrl || eP.slug || eP.title || (eL.current = e);
            }),
            (eQ[81] = eP.featuredImageUrl),
            (eQ[82] = eP.slug),
            (eQ[83] = eP.title),
            (eQ[84] = eo))
          : (eo = eQ[84]));
      let eZ = !!eP.featuredImageUrl;
      (eQ[85] !== eZ ? ((eu = g(eZ)), (eQ[85] = eZ), (eQ[86] = eu)) : (eu = eQ[86]),
        eQ[87] !== eP.featuredImageUrl
          ? ((ec = (e) => {
              (eM((t) => ({ ...t, featuredImageUrl: e.target.value })),
                eP.featuredImageUrl && eD(y));
            }),
            (eQ[87] = eP.featuredImageUrl),
            (eQ[88] = ec))
          : (ec = eQ[88]),
        eQ[89] !== eB
          ? ((eh = () => eB("featuredImageUrl")), (eQ[89] = eB), (eQ[90] = eh))
          : (eh = eQ[90]),
        eQ[91] !== eo ||
        eQ[92] !== eu ||
        eQ[93] !== ec ||
        eQ[94] !== eh ||
        eQ[95] !== e_.featuredImageUrl
          ? ((ed = (0, t.jsx)("input", {
              id: "featured-url",
              ref: eo,
              className: eu,
              value: e_.featuredImageUrl,
              onChange: ec,
              onBlur: eh,
              placeholder: "https://...",
            })),
            ...
            (eQ[96] = ed))
          : (ed = eQ[96]),
        eQ[97] !== eP.featuredImageUrl
          ? ((ep = (0, t.jsx)(b, { message: eP.featuredImageUrl })),
            (eQ[97] = eP.featuredImageUrl),
            (eQ[98] = ep))
          : (ep = eQ[98]),
        eQ[99] !== ed || eQ[100] !== ep
          ? ((ef = (0, t.jsxs)("div", { className: "space-y-1", children: [el, ed, ep] })),
            (eQ[99] = ed),
            (eQ[100] = ep),
            (eQ[101] = ef))
          : (ef = eQ[101]),
        eQ[102] !== en || eQ[103] !== ef
          ? ((em = (0, t.jsxs)("fieldset", {
              className: "space-y-4 border border-[var(--p-tan)] bg-[var(--p-white)] p-6",
              children: [er, es, en, ef],
            })),
            (eQ[102] = en),
            (eQ[103] = ef),
            (eQ[104] = em))
          : (em = eQ[104]),
        eQ[105] === Symbol.for("react.memo_cache_sentinel")
          ? ((eg = (0, t.jsx)("legend", {
              className:
                "px-2 text-xs font-semibold uppercase tracking-wider text-[var(--p-toffee)]",
            ...
            (eQ[106] = eb))
          : ((eg = eQ[105]), (eb = eQ[106])),
        eQ[107] === Symbol.for("react.memo_cache_sentinel")
          ? ((ev = (e) => eM((t) => ({ ...t, imageUrls: e }))), (eQ[107] = ev))
          : (ev = eQ[107]),
        eQ[108] !== ez || eQ[109] !== e_.imageUrls
          ? ((ey = (0, t.jsxs)("fieldset", {
              className: "space-y-4 border border-[var(--p-tan)] bg-[var(--p-white)] p-6",
              children: [
                eg,
                eb,
            ...
            (eQ[110] = ey))
          : (ey = eQ[110]),
        eQ[111] === Symbol.for("react.memo_cache_sentinel")
          ? ((ex = (0, t.jsx)("legend", {
              className:
                "px-2 text-xs font-semibold uppercase tracking-wider text-[var(--p-toffee)]",
              children: "Publishing",
            ...
            (eQ[111] = ex))
          : (ex = eQ[111]),
        eQ[112] === Symbol.for("react.memo_cache_sentinel")
          ? ((eR = (e) => eM((t) => ({ ...t, published: e.target.checked }))), (eQ[112] = eR))
          : (eR = eQ[112]),
        eQ[113] !== e_.published
          ? ((ej = (0, t.jsx)("input", {
              type: "checkbox",
              checked: e_.published,
              onChange: eR,
            ...
            (eQ[114] = ej))
          : (ej = eQ[114]),
        eQ[115] === Symbol.for("react.memo_cache_sentinel")
          ? ((ew = (0, t.jsx)("span", {
        ...
        eQ[116] !== ej
          ? ((eS = (0, t.jsxs)("fieldset", {
            ...
            (eQ[117] = eS))
          : (eS = eQ[117]));
      let eX = "create" === eE ? "Create project" : "Save changes";
      return (
        eQ[118] !== ez || eQ[119] !== eX
          ? ((eI = (0, t.jsx)("button", {
              type: "submit",
        ...
        eQ[121] !== eN
          ...
          : (eU = eQ[122]),
        eQ[123] !== eI || eQ[124] !== eU
          ? ((eO = (0, t.jsxs)("div", { className: "flex gap-3", children: [eI, eU] })),
            (eQ[123] = eI),
            (eQ[124] = eU),
            (eQ[125] = eO))
          : (eO = eQ[125]),
    ...
    function S(e) {
      return l.toast.error(e.message ?? "Failed to update");
    }
    function I(e) {
      return o.client.project.update(e);
    }
    function U(e) {
      return l.toast.error(e.message ?? "Failed to create");
    }
    function O(e) {
      return o.client.project.create(e);
    }
    function C(e) {
      return e.slug;
    }
    ...
    function E() {
      return o.client.project.listAdmin();
    }
    e.s(["ProjectForm", () => v]);
  },
]);
