module.exports = [
  ...
  (e, t, r) => {
    ...
    let o = (n = e.r(47540)) && n.__esModule ? n : { default: n },
      c = e.r(65252),
      u = e.r(97573),
      d = e.r(32319),
      l = e.r(56704),
      ...
      if (t)
        switch ((!r && (0, d.throwForMissingRequestStore)(e), r.type)) {
          ...
          case "prerender-ppr":
            ...
            throw Object.defineProperty(new p.BailoutToCSRError(e), "__NEXT_ERROR_CODE", {
              value: "E394",
              enumerable: !1,
              configurable: !0,
            });
          ...
          e &&
            (e.addEventListener(
              ...
              () => {
                let { reason: t } = e;
                (this.currentStage < 3 &&
                  (this.runtimeStagePromise.promise.catch(d), this.runtimeStagePromise.reject(t)),
