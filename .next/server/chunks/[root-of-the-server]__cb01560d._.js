module.exports = [
  ...
  (e, t, r) => {
    ...
    for (var p in l) s(o, p, { get: l[p], enumerable: !0 });
    function u(e) {
      var t;
      let r = [
        ...
        } = Object.fromEntries(s.map(([e, t]) => [e.toLowerCase().replace(/-/g, ""), t]));
      {
        var f,
          ...
          g = {
            ...
            path: l,
            ...(p && { sameSite: c.includes((f = (f = p).toLowerCase())) ? f : void 0 }),
            ...(u && { secure: !0 }),
            ...(_ && { priority: h.includes((x = (x = _).toLowerCase())) ? x : void 0 }),
            ...(m && { partitioned: !0 }),
          };
        let e = {};
        for (let t in g) g[t] && (e[t] = g[t]);
        return e;
      }
    }
    t.exports = ((e, t, r, o) => {
      if ((t && "object" == typeof t) || "function" == typeof t)
        for (let r of a(t))
          i.call(e, r) ||
            void 0 === r ||
            s(e, r, { get: () => t[r], enumerable: !(o = n(t, r)) || o.enumerable });
      return e;
                  ...
                  for (t = o, a = !1; l(); )
                    if ("," === (r = e.charAt(o))) {
                      ...
                      o < e.length && "=" === e.charAt(o)
                        ? ((a = !0), (o = n), i.push(e.substring(t, s)), (t = o))
                        : (o = s + 1);
                    } else o += 1;
    ...
    e.v((t) =>
      Promise.all(
        [
          ...
          "server/chunks/node_modules_next_dist_3cae5f3a._.js",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb01560d._.js.map
