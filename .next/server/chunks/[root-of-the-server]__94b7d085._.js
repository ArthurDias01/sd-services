module.exports = [
  ...
  (e) => {
      ...
      if (
        ...
        !(function (e) {
          try {
            ...
            if ("localhost" === t.hostname || t.hostname.endsWith(".vercel.app") || y.test(e))
              return !0;
            let r = process.env.R2_PUBLIC_URL;
            if (r) {
              let e = new URL(r);
              if (t.origin === e.origin) return !0;
            }
            return !1;
          } catch {
            return !1;
        ...
        return v.NextResponse.json({ error: "Invalid or disallowed URL" }, { status: 400 });
      let n = r.startsWith("/") ? new URL(r, e.url).toString() : r;
      try {
        let e = await fetch(n, { headers: { Accept: "image/*" }, cache: "force-cache" });
        if (!e.ok)
          return v.NextResponse.json({ error: "Upstream image failed" }, { status: e.status });
        let t = e.headers.get("Content-Type") ?? "image/jpeg",
          r = e.body;
        if (!r) return v.NextResponse.json({ error: "No image body" }, { status: 502 });
        return new v.NextResponse(r, {
          status: 200,
          headers: { "Content-Type": t, "Cache-Control": "public, max-age=31536000, immutable" },
        });
      } catch (e) {
        return (
          console.error("[api/image]", e),
          v.NextResponse.json({ error: "Failed to fetch image" }, { status: 502 })
        );
      }
    }
    e.s(["GET", () => w], 69204);
    ...
    let A = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: b, workUnitAsyncStorage: _, serverHooks: E } = A;
    function O() {
      return (0, n.patchFetch)({ workAsyncStorage: b, workUnitAsyncStorage: _ });
    }
    async function S(e, t, n) {
      A.isDev && (0, a.addRequestMeta)(e, "devRequestTimingInternalsEnd", process.hrtime.bigint());
      let v = "/api/image/route";
      v = v.replace(/\/index$/, "") || "/";
      let y = await A.prepare(e, t, { srcPage: v, multiZoneDraftMode: !1 });
      if (!y)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        U = (0, o.normalizeAppPath)(v),
        T = !!(E.dynamicRoutes[U] || E.routes[j]),
        $ = async () => (
      ...
      if (T && !_) {
        let e = !!E.routes[j],
          t = E.dynamicRoutes[U];
        if (t && !1 === t.fallback && !e) {
          if (C.experimental.adapterPath) return await $();
          throw new g.NoFallbackError();
        }
      }
      let q = null;
      !T || A.isDev || _ || (q = "/index" === (q = j) ? "/" : q);
      let D = !0 === A.isDev || !T,
        I = T && !D;
      P &&
        N &&
      ...
      let H = e.method || "GET",
        ...
        F = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, n, a) => A.onRequestError(e, t, n, a, O),
          },
          sharedContext: { buildId: R },
        },
        K = new l.NodeNextRequest(e),
        B = new l.NodeNextResponse(t),
        z = u.NextRequestAdapter.fromNodeNextRequest(K, (0, u.signalFromNodeResponse)(t));
      try {
        let i = async (e) =>
          ...
          l = async (a) => {
            ...
            let u = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  if (!T)
                    return (
                      await (0, c.sendResponse)(K, B, s, F.renderOpts.pendingWaitUntil), null
                    );
                  {
                    let e = await s.blob(),
            ...
            (o ||
              t.setHeader(
                "x-nextjs-cache",
                S ? "REVALIDATED" : p.isMiss ? "MISS" : p.isStale ? "STALE" : "HIT",
              ),
              _ &&
                t.setHeader(
                  "Cache-Control",
            ...
            let g = (0, h.fromNodeOutgoingHttpHeaders)(p.value.headers);
            return (
              (o && T) || g.delete(f.NEXT_CACHE_TAGS_HEADER),
              !p.cacheControl ||
                t.getHeader("Cache-Control") ||
                g.get("Cache-Control") ||
                g.set("Cache-Control", (0, m.getCacheControlHeader)(p.cacheControl)),
              await (0, c.sendResponse)(
                K,
                B,
                new Response(p.value.body, { headers: g, status: p.value.status || 200 }),
              ),
              null
            );
          };
        ...
        if (
          ...
          throw t;
        return (await (0, c.sendResponse)(K, B, new Response(null, { status: 500 })), null);
      }
    }
    e.s(
      [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94b7d085._.js.map
