module.exports = [
  ...
  (A) => {
    ...
    A.s(["GET", () => E, "dynamic", 0, "force-static"], 17868);
    var d = A.i(17868);
    let M = new w.AppRouteRouteModule({
      ...
      { workAsyncStorage: G, workUnitAsyncStorage: f, serverHooks: R } = M;
    function p() {
    ...
    async function v(A, w, P) {
      ...
      let {
        ...
        j = !!(p.dynamicRoutes[T] || p.routes[y]),
        V = async () => (
          ...
          n = async (e) => {
            ...
            let o = async ({ previousCacheEntry: D }) => {
                try {
                  ...
                  if (!j)
                    return (
                      await (0, B.sendResponse)(x, K, t, F.renderOpts.pendingWaitUntil), null
                    );
                  {
                    let A = await t.blob(),
            ...
            if (!j) return null;
            if (
              (null == a || null == (t = a.value) ? void 0 : t.kind) !== I.CachedRouteKind.APP_ROUTE
            )
