module.exports = [
  ...
  (e, r, t) => {
    ...
    function p() {
      ...
      if (r) {
        ...
        if (r.forceStatic)
          return y(n.RequestCookiesAdapter.seal(new a.RequestCookies(new Headers({}))));
        ...
        if (t)
          switch (t.type) {
            ...
            case "prerender":
              ...
              let s = h.get(b);
              if (s) return s;
              let g = (0, u.makeHangingPromise)(b.renderSignal, d.route, "`cookies()`");
              return (h.set(b, g), g);
            ...
            case "request":
              return (
                ...
                y((0, n.areCookiesMutableInCurrentPhase)(t) ? t.userspaceMutableCookies : t.cookies)
              );
          }
      }
        ...
        if (t)
          switch (t.type) {
            case "prerender":
              ...
              let a = p.get(y);
              if (a) return a;
              let o = (0, c.makeHangingPromise)(y.renderSignal, u.route, "`headers()`");
              return (p.set(y, o), o);
            case "prerender-client":
              let b = "`headers`";
              throw Object.defineProperty(
  ...
  93458,
  (e, r, t) => {
    ((r.exports.cookies = e.r(7460).cookies),
      (r.exports.headers = e.r(19971).headers),
      (r.exports.draftMode = e.r(21423).draftMode));
  },
];
