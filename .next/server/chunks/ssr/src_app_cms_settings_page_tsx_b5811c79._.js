module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(87924),
      ...
      i = a.i(68114),
      j = a.i(16570);
    let k = "hero_image_url",
      l = "contact_email",
      m = "contact_phone",
      n = "block text-xs font-semibold uppercase tracking-wider text-[var(--p-deep-walnut)]",
      o =
    ...
    function q() {
      let a = (0, e.useQuery)({
          queryKey: ["setting", k],
          queryFn: () => j.client.setting.get({ key: k }),
        }),
        q = (0, e.useQuery)({
          queryKey: ["setting", l],
          queryFn: () => j.client.setting.get({ key: l }),
        }),
        r = (0, e.useQuery)({
          queryKey: ["setting", m],
          queryFn: () => j.client.setting.get({ key: m }),
        }),
        s = (0, e.useQuery)({
          queryKey: ["projects-admin"],
          queryFn: () => j.client.project.listAdmin(),
        }),
        [t, u] = (0, c.useState)(null),
        v = t ?? a.data ?? "",
        [w, x] = (0, c.useState)(null),
        y = w ?? q.data ?? "",
        [z, A] = (0, c.useState)(null),
        B = z ?? r.data ?? "",
        C = (0, d.useMutation)({
          mutationFn: (a) => j.client.setting.upsert({ key: k, value: a }),
          onSuccess: () => {
            (f.toast.success("Hero image updated"),
              j.queryClient.invalidateQueries({ queryKey: ["setting", k] }));
          },
          onError: (a) => f.toast.error(a.message ?? "Failed to save"),
        }),
        D = (0, d.useMutation)({
          mutationFn: async () => {
            await Promise.all([
              j.client.setting.upsert({ key: l, value: y }),
              j.client.setting.upsert({ key: m, value: B }),
            ]);
          },
          onSuccess: () => {
            (f.toast.success("Contact details updated"),
              j.queryClient.invalidateQueries({ queryKey: ["setting", l] }),
              j.queryClient.invalidateQueries({ queryKey: ["setting", m] }));
          },
          onError: (a) => f.toast.error(a.message ?? "Failed to save"),
        }),
        E = (s.data ?? []).filter(
          (a) => "string" == typeof a.featuredImageUrl && "" !== a.featuredImageUrl,
        );
      return (0, b.jsxs)("div", {
            ...
            children: [
              ...
              E.length > 0 &&
                (0, b.jsxs)("div", {
                  className: "space-y-2",
                  children: [
                    (0, b.jsx)("label", { className: n, children: "Or select from a project" }),
                    (0, b.jsx)("div", {
            ...
            children: [
                ...
                children: [
                  ...
                  (0, b.jsxs)("p", {
                    ...
                    children: [
                      ...
                      " ",
                      (0, b.jsx)("code", { className: "font-mono", children: "+17045550199" }),
                      ".",
                    ],
                  }),
                ],
              ...
              (0, b.jsx)("div", {
                ...
                children: (0, b.jsx)("button", {
                  ...
                  children: D.isPending ? "Saving…" : "Save",
                }),
              }),
            ],
          }),
