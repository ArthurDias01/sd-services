module.exports = [
  ...
  (a) => {
    ...
    let I = [
        "",
        {
          children: [
                  ...
                  children: [
                    "new",
                    {
                      children: [
                        ...
                        {
                          metadata: {},
                          page: [() => a.r(34104), "[project]/src/app/cms/projects/new/page.tsx"],
                        },
                      ],
                    },
                    { metadata: {} },
            ...
            { metadata: {}, layout: [() => a.r(62270), "[project]/src/app/cms/layout.tsx"] },
          ],
        },
        {
          metadata: {
      ...
      K = new d.AppPageRouteModule({
        definition: {
          ...
          page: "/cms/projects/new/page",
          pathname: "/cms/projects/new",
          bundlePath: "",
          filename: "",
          appPaths: [],
        },
    ...
    async function L(a, b, c) {
      ...
      let aD = aC;
      (!aD && K.isDev && (aD = _),
        K.isDev || $ || !ay || !ao || av || (0, k.stripFlightHeaders)(a.headers));
      let aE = {
        ...D,
        tree: I,
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
          ...
          o = async ({
            ...
            if (
              ...
              if (ar && (ac.cacheComponents ? !av : !ao)) {
                let b =
                    p && "string" == typeof (null == ai ? void 0 : ai.fallback) ? ai.fallback : ag,
                  d =
          ...
          p = async (d) => {
            ...
            let r = az
              ...
              : (0, h.getRequestMeta)(a, "onCacheEntry");
            if (r && (await r(n, { url: (0, h.getRequestMeta)(a, "initURL") ?? a.url })))
              return null;
            if (q.headers) {
              let a = { ...q.headers };
              for (let [c, d] of ((M && ay) || delete a[x.NEXT_CACHE_TAGS_HEADER],
              Object.entries(a)))
                if (void 0 !== d)
    ...
    (a.s(["__next_app__", 0, J, "handler", () => L, "routeModule", 0, K], 22197),
      a.i(22197),
      a.s(
        [
          "ClientPageRoot",
...
//# sourceMappingURL=_b84b1c11._.js.map
