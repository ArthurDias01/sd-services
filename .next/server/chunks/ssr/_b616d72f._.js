module.exports = [
  ...
  (a) => {
    ...
    async function n(a) {
      let b = new FormData();
      for (let c of a) b.append("files", c);
      let c = await fetch("/api/upload", { method: "POST", body: b, credentials: "include" });
      if (!c.ok) throw Error((await c.json().catch(() => ({}))).error ?? "Upload failed");
      let d = await c.json();
      return d.urls ?? (d.url ? [d.url] : []);
    }
    function o({ value: a, onChange: c, multiple: d = !0, className: e, disabled: f = !1 }) {
      let g = (0, b.useRef)(null),
        ...
        s = (0, b.useCallback)(
          async (b) => {
            let e = Array.from(b).filter((a) => a.type.startsWith("image/"));
            if (0 !== e.length) {
              if (!d && e.length > 1) return void k.toast.error("Only one image allowed here.");
              (p(!0), r(e.length));
              try {
                let b = await n(e);
                c(d ? [...a, ...b] : b);
              } catch (a) {
                k.toast.error(a instanceof Error ? a.message : "Upload failed");
              } finally {
                (p(!1), r(0), g.current && (g.current.value = ""));
              }
            }
          },
          [d, c, a],
        ...
        t = (0, b.useCallback)(
          (a) => {
            (a.preventDefault(), i(!1), f || o || s(a.dataTransfer.files));
          },
          [f, s, o],
        ),
        u = d || 0 === a.length;
      return (0, j.jsxs)("div", {
        className: (0, m.cn)("space-y-3", e),
        children: [
          a.length > 0 &&
            (0, j.jsxs)("div", {
                ...
                a.map((b) =>
                  (0, j.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        (0, j.jsx)("img", {
                          src: (0, l.proxyImageUrlIfNeeded)(b),
                          alt: "",
          ...
          u &&
            (0, j.jsxs)("div", {
              ...
              onDragLeave: () => i(!1),
              onDrop: t,
              onClick: () => !f && !o && g.current?.click(),
              onKeyDown: (a) => {
                ("Enter" === a.key || " " === a.key) &&
                  (a.preventDefault(), f || o || g.current?.click());
              },
              className: (0, m.cn)(
                ...
                (f || o) && "cursor-not-allowed opacity-50",
              ),
              children: [
                (0, j.jsxs)("svg", {
                  width: "28",
                ...
                (0, j.jsxs)("div", {
                  children: [
                    (0, j.jsx)("p", {
                      ...
                      children: o
                        ? `Uploading ${q} file${q > 1 ? "s" : ""}…`
                        : "Click to upload or drag & drop",
                    }),
                    (0, j.jsx)("p", {
                      className: "mt-0.5 text-[11px] text-[var(--p-coffee-bean)]/60",
                      children: d ? "PNG, JPG, WEBP — multiple allowed" : "PNG, JPG, WEBP",
                    }),
                  ],
                }),
              ],
          ...
          !d &&
            ...
            (0, j.jsx)("button", {
              ...
              children: o ? "Uploading…" : "Replace image",
            }),
          (0, j.jsx)("input", {
            ref: g,
            type: "file",
            ...
            "aria-hidden": !0,
            onChange: (a) => {
              a.target.files && s(a.target.files);
            },
          }),
        ],
      });
    }
    a.s(["ImageUploader", () => o], 48964);
  },
];

//# sourceMappingURL=_b616d72f._.js.map
