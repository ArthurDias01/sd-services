module.exports = [
  ...
  (a) => {
    ...
    var c = a.i(99745),
      ...
      h = a.i(42871),
      i = a.i(8361),
      j = class extends f.Subscribable {
        constructor(a, b) {
          (super(),
            (this.options = b),
            (this.#a = a),
        ...
        onSubscribe() {
          1 === this.listeners.size &&
            ...
            k(this.#d, this.options) ? this.#p() : this.updateResult(),
            this.#q());
        }
        onUnsubscribe() {
        ...
        shouldFetchOnReconnect() {
          return l(this.#d, this.options, this.options.refetchOnReconnect);
        }
        ...
        setOptions(a) {
          ...
          (d && m(this.#d, c, this.options, b) && this.#p(),
            this.updateResult(),
            d &&
              (this.#d !== c ||
        ...
        #u() {
          ...
          this.#l = i.timeoutManager.setTimeout(() => {
        ...
        #w(a) {
          (this.#s(),
            ...
            !h.isServer &&
              ...
              0 !== this.#n &&
              (this.#m = i.timeoutManager.setInterval(() => {
                (this.options.refetchIntervalInBackground || c.focusManager.isFocused()) &&
                  this.#p();
              }, this.#n)));
        }
        #q() {
        ...
        #r() {
          this.#l && (i.timeoutManager.clearTimeout(this.#l), (this.#l = void 0));
        }
        #s() {
          this.#m && (i.timeoutManager.clearInterval(this.#m), (this.#m = void 0));
        }
        createResult(a, b) {
          let c,
            d = this.#d,
          ...
          if (void 0 !== b.placeholderData && void 0 === c && "pending" === u) {
            let a;
            (i?.isPlaceholderData && b.placeholderData === l?.placeholderData
              ? ((a = i.data), (v = !0))
              : (a =
          ...
          if (b.select && void 0 !== c && !v)
            if (i && c === j?.data && b.select === this.#i) c = this.#j;
            else
              try {
                ((this.#i = b.select),
                  (c = b.select(c)),
          ...
          let w = "fetching" === q.fetchStatus,
            ...
            B = {
              ...
              promise: this.#c,
              isEnabled: !1 !== (0, h.resolveEnabled)(b.enabled, a),
            };
          if (this.options.experimental_prefetchInRender) {
            let b = void 0 !== B.data,
              ...
              f = () => {
                e((this.#c = B.promise = (0, g.pendingThenable)()));
              },
              h = this.#c;
            switch (h.status) {
              case "pending":
                a.queryHash === d.queryHash && e(h);
                break;
              case "fulfilled":
                (c || B.data !== h.value) && f();
                break;
              case "rejected":
                (c && B.error === h.reason) || f();
            }
          }
          return B;
        }
    ...
    function k(a, b) {
      return (
        ...
        (void 0 !== a.state.data && l(a, b, b.refetchOnMount))
      );
    }
    function l(a, b, c) {
      if (
        !1 !== (0, h.resolveEnabled)(b.enabled, a) &&
        "static" !== (0, h.resolveStaleTime)(b.staleTime, a)
      ) {
        let d = "function" == typeof c ? c(a) : c;
        return "always" === d || (!1 !== d && n(a, b));
      }
      return !1;
    }
    function m(a, b, c, d) {
    ...
    function n(a, b) {
      return (
        !1 !== (0, h.resolveEnabled)(b.enabled, a) &&
        a.isStaleByTime((0, h.resolveStaleTime)(b.staleTime, a))
      );
    }
    var o = a.i(72131),
      p = a.i(11508);
    ...
    function t(a, b) {
      return (function (a, b, c) {
        let e,
          f = o.useContext(r),
          g = o.useContext(q),
          i = (0, p.useQueryClient)(c),
          j = i.defaultQueryOptions(a);
        i.getDefaultOptions().queries?._experimental_beforeQuery?.(j);
        let k = i.getQueryCache().get(j.queryHash);
        if (((j._optimisticResults = f ? "isRestoring" : "optimistic"), j.suspense)) {
          let a = (a) => ("static" === a ? a : Math.max(a ?? 1e3, 1e3)),
            b = j.staleTime;
          ((j.staleTime = "function" == typeof b ? (...c) => a(b(...c)) : a(b)),
            "number" == typeof j.gcTime && (j.gcTime = Math.max(j.gcTime, 1e3)));
        }
        ((e =
          k?.state.error && "function" == typeof j.throwOnError
            ? (0, h.shouldThrowError)(j.throwOnError, [k.state.error, k])
            : j.throwOnError),
          (j.suspense || j.experimental_prefetchInRender || e) &&
            !g.isReset() &&
            (j.retryOnMount = !1),
          o.useEffect(() => {
            g.clearReset();
          }, [g]));
        let l = !i.getQueryCache().get(j.queryHash),
          [m] = o.useState(() => new b(i, j)),
          n = m.getOptimisticResult(j),
          t = !f && !1 !== a.subscribed;
        if (
          (o.useSyncExternalStore(
            o.useCallback(
              (a) => {
                let b = t ? m.subscribe(d.notifyManager.batchCalls(a)) : h.noop;
                return (m.updateResult(), b);
              },
              [m, t],
            ),
            () => m.getCurrentResult(),
        ...
        if (
          ...
          throw n.error;
        if (
          (i.getDefaultOptions().queries?._experimental_afterQuery?.(j, n),
          j.experimental_prefetchInRender && !h.isServer && n.isLoading && n.isFetching && !f)
        ) {
          let a = l ? s(j, m, g) : k?.promise;
          a?.catch(h.noop).finally(() => {
            m.updateResult();
          });
        }
        return j.notifyOnChangeProps ? n : m.trackResult(n);
      })(a, j, b);
    }
    a.s(["useQuery", () => t], 33217);
  },
  48848,
  (a) => {
    "use strict";
    var b = a.i(87924),
      ...
      f = a.i(68114);
    function g() {
      let { data: a, isPending: g } = (0, d.useQuery)({
        queryKey: ["projects", "admin"],
        queryFn: () => e.client.project.listAdmin(),
      });
      return (0, b.jsxs)("div", {
        className: "space-y-8",
        children: [
          (0, b.jsxs)("div", {
            ...
            children: [
              ...
              (0, b.jsx)(c.default, {
                ...
                className:
                  "inline-flex h-9 items-center justify-center border-2 border-[var(--p-deep-walnut)] bg-[var(--p-deep-walnut)] px-5 text-xs font-semibold text-[var(--p-white)] outline-none transition-opacity hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[var(--p-deep-walnut)] focus-visible:ring-offset-2",
          ...
          g
            ? (0, b.jsx)("div", {
                className: "grid gap-px bg-[var(--p-tan)]/30 sm:grid-cols-2 lg:grid-cols-3",
                children: [1, 2, 3].map((a) =>
                  (0, b.jsxs)(
                    "div",
                    {
                      className: "space-y-3 bg-[var(--p-white)] p-5",
                      children: [
                        (0, b.jsx)("div", {
                          className: "h-4 w-28 rounded bg-[var(--p-warm-white)]",
                        }),
                        (0, b.jsx)("div", {
                          className: "h-3 w-20 rounded bg-[var(--p-warm-white)]",
                        }),
                      ],
                    },
                    a,
            ...
            : a?.length === 0
              ? (0, b.jsxs)("div", {
                  className:
                    "border border-[var(--p-tan)] bg-[var(--p-white)] px-6 py-12 text-center",
                  children: [
                    (0, b.jsx)("p", {
                      className: "text-sm text-pretty text-[var(--p-coffee-bean)]",
                      children: "No projects yet.",
                    }),
                    (0, b.jsx)(c.default, {
                      href: "/cms/projects/new",
                      className:
                        "mt-4 inline-flex h-9 items-center justify-center border-2 border-[var(--p-toffee)] bg-transparent px-5 text-xs font-semibold text-[var(--p-toffee)] outline-none transition-opacity hover:opacity-80 focus-visible:ring-2 focus-visible:ring-[var(--p-toffee)] focus-visible:ring-offset-2",
                        ...
                        children: [
                          (0, b.jsxs)("div", {
                            children: [
                              ...
                              (0, b.jsxs)("code", {
                                className: "mt-1 block text-xs text-[var(--p-toffee)]",
                                children: ["/", a.slug],
                              }),
                            ],
                          }),
                          (0, b.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, b.jsx)("span", {
                                className:
                                  "text-xs font-medium text-[var(--p-coffee-bean)] opacity-0 transition-opacity group-hover:opacity-100",
                                children: "Edit",
                              }),
                            ],
                          }),
...
//# sourceMappingURL=_95757869._.js.map
