  ...
  (a) => {
                      ...
                      let d =
                        ...
                        f =
                          "function" == typeof c.description
                            ...
                            : c.description,
                        h =
                          "object" != typeof d || b.default.isValidElement(d) ? { message: d } : d;
            ...
            ? b.default.createElement(
                "button",
                {
                  ...
                  onClick: (a) => {
                    !o(y.cancel) ||
                      (as &&
                        (null == y.cancel.onClick || y.cancel.onClick.call(y.cancel, a), aI()));
                  },
                  className: p(
    ...
    let s = b.default.forwardRef(function (a, d) {
      let {
        ...
        B = b.default.useMemo(
          () => (e ? z.filter((a) => a.toasterId === e) : z.filter((a) => !a.toasterId)),
          [z, e],
        ),
        C = b.default.useMemo(
                  ...
                  "ol",
                  {
                    ...
                    onBlur: (a) => {
                      O.current &&
                        ...
                        ((O.current = !1),
                        N.current && (N.current.focus({ preventScroll: !0 }), (N.current = null)));
                    },
                    onFocus: (a) => {
                      !(
