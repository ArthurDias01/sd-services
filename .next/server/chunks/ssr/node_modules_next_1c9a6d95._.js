module.exports = [
          ...
          switch (c.type) {
            ...
            case "request":
              return (
                ...
                p((0, d.areCookiesMutableInCurrentPhase)(c) ? c.userspaceMutableCookies : c.cookies)
              );
          }
      }
  ...
  (a, b, c) => {
    ...
    function k() {
      ...
      switch (((!a || !b) && (0, d.throwForMissingRequestStore)("draftMode"), b.type)) {
        case "prerender-runtime":
        ...
        if (g)
          switch (g.type) {
            ...
            case "private-cache": {
              ...
              throw (Error.captureStackTrace(d, b), (c.invalidDynamicUsageError ??= d), d);
            }
            case "unstable-cache":
              throw Object.defineProperty(
                Error(
  ...
  17097,
  (a, b, c) => {
    ((b.exports.cookies = a.r(52322).cookies),
      (b.exports.headers = a.r(20453).headers),
      (b.exports.draftMode = a.r(14422).draftMode));
  },
];
