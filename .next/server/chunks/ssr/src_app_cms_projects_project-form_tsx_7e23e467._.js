module.exports = [
  ...
  (a) => {
    ...
    function n(a, b, c = []) {
      if ("slug" === a) {
        if (!b.trim()) return "Slug is required";
        if (!l.test(b)) return "Slug must be lowercase letters, numbers, and hyphens only";
        if (c.includes(b.trim().toLowerCase()))
          return "This slug is already used by another project.";
      }
      if ("title" === a && !b.trim()) return "Title is required";
    }
    let o = "block text-xs font-semibold uppercase tracking-wider text-[var(--p-deep-walnut)]";
    function p(a) {
      return (0, j.cn)(
    ...
    function r({ mode: a, id: j, initialData: l }) {
      let r = (0, d.useRouter)(),
        [s, t] = (0, c.useState)(l ?? k),
        [u, v] = (0, c.useState)({}),
        w = (0, c.useRef)(!!l?.slug),
        x = (0, c.useRef)(null),
        { data: y } = (0, f.useQuery)({
          queryKey: ["projects", "admin"],
          queryFn: () => h.client.project.listAdmin(),
        }),
        z =
          "create" === a
            ? (y?.map((a) => a.slug) ?? [])
            : (y?.filter((a) => a.id !== j).map((a) => a.slug) ?? []),
        A = (0, e.useMutation)({
          mutationFn: (a) => h.client.project.create(a),
          onSuccess: () => {
            (g.toast.success("Project created"), r.push("/cms/projects"));
          },
          onError: (a) => g.toast.error(a.message ?? "Failed to create"),
        }),
        B = (0, e.useMutation)({
          mutationFn: (a) => h.client.project.update(a),
          onSuccess: () => {
            (g.toast.success("Project updated"), r.push("/cms/projects"));
          },
          onError: (a) => g.toast.error(a.message ?? "Failed to update"),
        }),
        C = A.isPending || B.isPending,
        D = (0, c.useCallback)(
          (a) => {
            let b = n(a, s[a], z);
            v((c) => ({ ...c, [a]: b }));
      ...
      return (0, b.jsxs)("form", {
        onSubmit: function (b) {
          ...
          let c = (function (a, b = []) {
            let c = {};
            for (let d of ["slug", "title"]) {
              let e = n(d, a[d], b);
              e && (c[d] = e);
            }
            return c;
          })(s, z);
          if ((v(c), Object.keys(c).length > 0))
          ...
          let d = {
            ...
            featuredImageUrl: s.featuredImageUrl.trim() || null,
            published: s.published,
            imageUrls: s.imageUrls.filter(Boolean),
          };
          "create" === a ? A.mutate(d) : j && B.mutate({ id: j, ...d });
        },
        ...
        children: [
              ...
              (0, b.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, b.jsx)("input", {
                    id: "title",
                    ref: (a) => {
                      u.title && !u.slug && (x.current = a);
                    },
                    className: p(!!u.title),
                    value: s.title,
                    onChange: function (a) {
                      let b = a.target.value;
                      (t((a) => ({ ...a, title: b, slug: w.current ? a.slug : m(b) })),
                        u.title && v((a) => ({ ...a, title: void 0 })),
                        !w.current && u.slug && v((a) => ({ ...a, slug: void 0 })));
                    },
                    onBlur: () => D("title"),
                    placeholder: "Sharon Lane Kitchen",
                  }),
                  (0, b.jsx)(q, { message: u.title }),
                ],
              }),
              (0, b.jsxs)("div", {
                className: "space-y-1.5",
                children: [
                  ...
                  (0, b.jsx)("input", {
                    ...
                    onChange: function (a) {
                      let b = a.target.value,
                        c = m(b) || b.replace(/[^a-z0-9-]/gi, "").toLowerCase();
                      ((w.current = !0),
                        t((a) => ({ ...a, slug: c })),
                        u.slug && v((a) => ({ ...a, slug: void 0 })));
                    },
                    onBlur: () => D("slug"),
                    placeholder: "sharon-lane-kitchen",
                  }),
                  (0, b.jsxs)("p", {
                    ...
                    children: [
                      ...
                      " ",
                      (0, b.jsx)("code", { className: "font-mono", children: "/projects/[slug]" }),
                      ".",
                    ],
                  }),
                  (0, b.jsx)(q, { message: u.slug }),
                ],
              }),
              (0, b.jsxs)("div", {
                className: "space-y-1.5",
                children: [
                  ...
                  (0, b.jsx)("textarea", {
                    ...
                    value: s.description,
                    onChange: (a) => t((b) => ({ ...b, description: a.target.value })),
                  }),
                ],
              }),
            ],
          ...
          (0, b.jsxs)("fieldset", {
            ...
            children: [
              ...
              (0, b.jsx)(i.ImageUploader, {
                multiple: !1,
                value: s.featuredImageUrl ? [s.featuredImageUrl] : [],
                onChange: (a) => {
                  (t((b) => ({ ...b, featuredImageUrl: a[0] ?? "" })),
                    v((a) => ({ ...a, featuredImageUrl: void 0 })));
                },
                disabled: C,
              }),
              (0, b.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, b.jsx)("input", {
                    id: "featured-url",
                    ref: (a) => {
                      !u.featuredImageUrl || u.slug || u.title || (x.current = a);
                    },
                    className: p(!!u.featuredImageUrl),
                    value: s.featuredImageUrl,
                    onChange: (a) => {
                      (t((b) => ({ ...b, featuredImageUrl: a.target.value })),
                        u.featuredImageUrl && v((a) => ({ ...a, featuredImageUrl: void 0 })));
                    },
                    onBlur: () => D("featuredImageUrl"),
                    placeholder: "https://...",
                  }),
                  (0, b.jsx)(q, { message: u.featuredImageUrl }),
                ],
              }),
            ],
          }),
              ...
              (0, b.jsxs)("label", {
                ...
                children: [
                  (0, b.jsx)("input", {
                    type: "checkbox",
                    checked: s.published,
                    onChange: (a) => t((b) => ({ ...b, published: a.target.checked })),
          ...
          (0, b.jsxs)("div", {
            ...
            children: [
              (0, b.jsx)("button", {
                ...
                disabled: C,
                children: "create" === a ? "Create project" : "Save changes",
              }),
              (0, b.jsx)("button", {
                type: "button",
                className:
