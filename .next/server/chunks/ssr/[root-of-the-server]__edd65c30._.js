module.exports = [
  ...
  (a) => {
    "use strict";
    a.s(["ProjectCarousel", () => b]);
    let b = (0, a.i(11857).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call ProjectCarousel() from the server but ProjectCarousel is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      "[project]/src/components/project-carousel.tsx <module evaluation>",
      "ProjectCarousel",
    );
  },
  12686,
  (a) => {
    ...
    let b = (0, a.i(11857).registerClientReference)(
      ...
      "[project]/src/components/project-carousel.tsx",
      "ProjectCarousel",
    );
  },
  98390,
    ...
    b.exports = function (a, b) {
      ...
      function s() {
        ...
        if ("/" == a.charAt(0) && "*" == a.charAt(1)) {
          for (var c = 2; "" != a.charAt(c) && ("*" != a.charAt(c) || "/" != a.charAt(c + 1)); )
            ++c;
          if (((c += 2), "" === a.charAt(c - 1))) return p("End of comment missing");
          var d = a.slice(2, c - 2);
  ...
  (a) => {
    ...
    let i = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
      j = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
      k = {};
    function l(a, b) {
      return ((b || k).jsx ? j : i).test(a);
    }
    let m = /[ \t\n\f\r]/g;
    function n(a) {
      return "" === a.replace(m, "");
    ...
    function K(a) {
      ...
      for (let [d, e] of Object.entries(a.properties)) {
        let f = new A(d, a.transform(a.attributes || {}, d), e, a.space);
        (a.mustUseProperty && a.mustUseProperty.includes(d) && (f.mustUseProperty = !0),
          (b[d] = f),
          (c[B(d)] = d),
          (c[B(f.attribute)] = d));
      }
      return new I(b, c, a.space);
    }
    ...
    function $(a) {
      return aa(a && a.line) + ":" + aa(a && a.column);
    }
    function _(a) {
      return $(a && a.start) + "-" + $(a && a.end);
    }
    function aa(a) {
    ...
    ((ab.prototype.file = ""),
      (ab.prototype.name = ""),
      (ab.prototype.reason = ""),
      (ab.prototype.message = ""),
      (ab.prototype.stack = ""),
      (ab.prototype.column = void 0),
      (ab.prototype.line = void 0),
      (ab.prototype.ancestors = void 0),
      (ab.prototype.cause = void 0),
      (ab.prototype.fatal = void 0),
      (ab.prototype.place = void 0),
      (ab.prototype.ruleId = void 0),
      (ab.prototype.source = void 0));
    let ac = {}.hasOwnProperty,
      ad = new Map(),
      ae = /[A-Z]/g,
      af = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
      ag = new Set(["td", "th"]),
      ah = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
    function ai(a, b, c) {
      ...
      return "element" === b.type
        ? ((d = a),
          ...
          (f = c),
          (q = p = d.schema),
          "svg" === e.tagName.toLowerCase() && "html" === p.space && (d.schema = U),
          d.ancestors.push(e),
          (r = am(d, e.tagName, !1)),
          (s = (function (a, b) {
            let c,
            ...
            for (d in b.properties)
              if ("children" !== d && ac.call(b.properties, d)) {
                let f = (function (a, b, c) {
                  let d = (function (a, b) {
                    ...
                    if (c.length > 4 && "data" === c.slice(0, 4) && E.test(b)) {
                      if ("-" === b.charAt(4)) {
                        let a = b.slice(5).replace(D, G);
                    ...
                    if (
                      ...
                      let b =
                        "object" == typeof c
                          ...
                          : (function (a, b) {
                              try {
                                return (0, V.default)(b, { reactCompat: !0 });
                              } catch (c) {
                                if (a.ignoreInvalidStyle) return {};
                                let b = new ab("Cannot parse `style` attribute", {
                                ...
                                throw (
                                  ...
                                  (b.url = ah + "#cannot-parse-style-attribute"),
                                  b
                                );
                              }
                            })(a, String(c));
                          ...
                          (b = (function (a) {
                            ...
                            for (b in a)
                              ac.call(a, b) &&
                                (c[
                                  (function (a) {
                                    let b = a.replace(ae, ao);
                                    return ("ms-" === b.slice(0, 3) && (b = "-" + b), b);
                                  })(b)
                                ] = a[b]);
                            return c;
                          })(b)),
          ...
          af.has(e.tagName) &&
            (t = t.filter(function (a) {
              return (
                "string" != typeof a ||
                !("object" == typeof a ? "text" === a.type && n(a.value) : n(a))
              );
            })),
          aj(d, s, r, e),
          ak(s, t),
        ...
        : "mdxFlowExpression" === b.type || "mdxTextExpression" === b.type
          ? (function (a, b) {
              if (b.data && b.data.estree && a.evaluater) {
                ...
                return (
                  g("ExpressionStatement" === c.type), a.evaluater.evaluateExpression(c.expression)
                );
              }
              an(a, b.position);
            })(a, b)
          : "mdxJsxFlowElement" === b.type || "mdxJsxTextElement" === b.type
            ? ((h = a),
              ...
              (j = c),
              (v = u = h.schema),
              "svg" === i.name && "html" === u.space && (h.schema = U),
              h.ancestors.push(i),
              (w = null === i.name ? h.Fragment : am(h, i.name, !0)),
              (x = (function (a, b) {
                let c = {};
                for (let d of b.attributes)
                  if ("mdxJsxExpressionAttribute" === d.type)
                    if (d.data && d.data.estree && a.evaluater) {
                      ...
                      g("ExpressionStatement" === b.type);
                      let e = b.expression;
                      g("ObjectExpression" === e.type);
                      let f = e.properties[0];
                      (g("SpreadElement" === f.type),
                        Object.assign(c, a.evaluater.evaluateExpression(f.argument)));
                    } else an(a, b.position);
                  else {
                    let e,
                      f = d.name;
            ...
            : "mdxjsEsm" === b.type
              ...
              : "root" === b.type
                ? ((k = a), (l = b), (m = c), ak((z = {}), al(k, l)), k.create(l, k.Fragment, z, m))
                : "text" === b.type
                  ? b.value
                  : void 0;
    }
    ...
    function am(a, b, c) {
      ...
      if (c)
        if (b.includes(".")) {
          let a,
            ...
            e = -1;
          for (; ++e < c.length; ) {
            let b = l(c[e]) ? { type: "Identifier", name: c[e] } : { type: "Literal", value: c[e] };
            a = a
              ? {
      ...
      if ("Literal" === d.type) {
        let b = d.value;
        return ac.call(a.components, b) ? a.components[b] : b;
      }
      if (a.evaluater) return a.evaluater.evaluateExpression(d);
      an(a);
    }
    function an(a, b) {
      let c = new ab("Cannot handle MDX estrees without `createEvaluater`", {
        ancestors: a.ancestors,
        place: b,
        ruleId: "mdx-estree",
        source: "hast-util-to-jsx-runtime",
      ...
      throw (
        ...
        (c.url = ah + "#cannot-handle-mdx-estrees-without-createevaluater"),
        c
      );
    }
    function ao(a) {
    ...
    function as(a, b, c) {
      ...
      if ((d = a) && "object" == typeof d) {
        ...
        if ("children" in a) return at(a.children, b, c);
      }
      return Array.isArray(a) ? at(a, b, c) : "";
    }
    function at(a, b, c) {
      let d = [],
        e = -1;
      for (; ++e < a.length; ) d[e] = as(a[e], b, c);
      return d.join("");
    }
    function au(a, b, c, d) {
      let e,
    ...
    function av(a, b) {
      return a.length > 0 ? (au(a, a.length, 0, b), a) : b;
    }
    let aw = {}.hasOwnProperty;
    function ax(a) {
      let b = {},
        c = -1;
      for (; ++c < a.length; )
                  ...
                  (function c(d) {
                    ...
                    return (
                      ...
                      (function b(d) {
                        ...
                        return aF(d) ? (a.consume(d), a.exit("chunkText"), c) : (a.consume(d), b);
                      })(d)
                    );
                  })(c)
                );
        ...
        tokenize: function (a) {
          ...
          function i(a) {
            if ((g++, e.containerState._closeFlow)) {
              ...
              return (au(e.events, f + 1, 0, e.events.slice(d)), (e.events.length = h), j(a));
            }
            return h(a);
          }
          function j(c) {
          ...
          function p(a, f) {
            ...
            if (
              ...
              (au(e.events, i + 1, 0, e.events.slice(h)), (e.events.length = f));
            }
          }
          function q(b) {
            let c = f.length;
                ...
                for (; n; ) {
                  ...
                  (h.push(g),
                    !n._tokenizer &&
                      ...
                      n._isInFirstContentOfListItem && (i._gfmTasklistFirstContentOfListItem = !0),
                      i.write(c),
    ...
    let aT = {
        ...
        tokenize: function (a, b) {
          ...
          return function (b) {
            return (
              a.enter("content"), (c = a.enter("chunkContent", { contentType: "content" })), d(b)
            );
          };
          function d(b) {
            return null === b ? e(b) : aF(b) ? a.check(aU, f, e)(b) : (a.consume(b), d);
          }
          function e(c) {
          ...
          let b = this,
            c = a.attempt(
              ...
              a.attempt(
                ...
                d,
                aL(a, a.attempt(this.parser.constructs.flow, d, a.attempt(aT, d)), "linePrefix"),
              ),
            );
          return c;
          function d(d) {
      ...
      return function (b, c) {
        ...
        for (; ++e <= b.length; )
          void 0 === d
            ...
            : (b[e] && "data" === b[e][1].type) ||
              (e !== d + 2 &&
                ((b[d][1].end = b[e - 1][1].end), b.splice(d + 2, e - d - 2), (e = d + 2)),
              (d = void 0));
        return a ? a(b, c) : b;
      };
    }
            ...
            for (c = k; c--; )
              if (
                ...
                (a3(l, -h),
                  ...
                  (i = av(i, a1(b.parser.constructs.insideSpan.null, a.slice(c + 1, k), b))),
                  (i = av(i, [
                    ["exit", e, b],
                    ["enter", g, b],
                    ["exit", g, b],
          ...
          let d,
            ...
            f = {
              ...
              tokenize: function (a, b, c) {
                ...
                function j(d) {
                  return null === d || aF(d) ? (a.exit("codeFencedFence"), b(d)) : c(d);
                }
              },
            },
            g = 0,
            ...
            return (
              ...
              (function b(e) {
                return e === d
                  ...
                  : h < 3
                    ? c(e)
                    : (a.exit("codeFencedFenceSequence"), aH(e) ? aL(a, i, "whitespace")(e) : i(e));
              })(f)
            );
          };
          function i(f) {
            return null === f || aF(f)
              ? (a.exit("codeFencedFence"), e.interrupt ? b(f) : a.check(ba, k, o)(f))
          ...
          function n(b) {
            return null === b || aF(b)
              ...
              : (a.enter("codeFlowValue"),
                (function b(c) {
                  return null === c || aF(c) ? (a.exit("codeFlowValue"), n(c)) : (a.consume(c), b);
                })(b));
          }
          function o(c) {
      ...
      function i(b) {
        return b === g
          ...
          : null === b
            ? c(b)
            : aF(b)
              ? (a.enter("lineEnding"), a.consume(b), a.exit("lineEnding"), aL(a, i, "linePrefix"))
    ...
    let bj = {
      ...
      bm = {
        ...
        tokenize: function (a, b, c) {
          return function (d) {
            return (a.enter("lineEnding"), a.consume(d), a.exit("lineEnding"), a.attempt(aP, b, c));
          };
        },
      },
      bn = {
        ...
        tokenize: function (a, b, c) {
          let d = this;
          return function (b) {
            return aF(b) ? (a.enter("lineEnding"), a.consume(b), a.exit("lineEnding"), e) : c(b);
          };
          function e(a) {
            return d.parser.lazy[d.now().line] ? c(a) : b(a);
          }
      ...
      bo = {
        ...
        resolveAll: function (a) {
          ...
          for (; ++b < a.length; ) {
            ...
            if (
              (c.push(a[b]),
              "labelImage" === d.type || "labelLink" === d.type || "labelEnd" === d.type)
            ) {
              let a = "labelImage" === d.type ? 4 : 2;
              ((d.type = "data"), (b += a));
            }
          }
          return (a.length !== c.length && au(a, 0, a.length, c), a);
        },
        resolveTo: function (a, b) {
          ...
          return (
            ...
            (f = av(f, [["enter", k, b]])),
            (f = av(f, a1(b.parser.constructs.insideSpan.null, a.slice(d + h + 4, e - 3), b))),
            (f = av(f, [["exit", k, b], a[e - 2], a[e - 1], ["exit", j, b]])),
            (f = av(f, a.slice(e + 1))),
            (f = av(f, [["exit", i, b]])),
            au(a, d, a.length, f),
            a
      ...
      bp = {
        tokenize: function (a, b, c) {
          ...
          function h(b) {
            return 34 === b || 39 === b || 40 === b
              ? bg(a, i, c, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(b)
              : j(b);
          }
          function i(b) {
      ...
      bq = {
        tokenize: function (a, b, c) {
          let d = this;
          return function (b) {
            return bf.call(d, a, e, f, "reference", "referenceMarker", "referenceString")(b);
          };
          function e(a) {
            return d.parser.defined.includes(
              bi(d.sliceSerialize(d.events[d.events.length - 1][1]).slice(1, -1)),
            )
              ? b(a)
              : c(a);
          }
      ...
      bu = {
        ...
        tokenize: function (a, b) {
          return function (c) {
            return (
              a.enter("lineEnding"), a.consume(c), a.exit("lineEnding"), aL(a, b, "linePrefix")
            );
          };
        },
      },
      ...
      bw = {
        ...
        tokenize: function (a, b, c) {
          ...
          return function (b) {
            ...
            if (
              ...
              if (
                ...
                return (
                  a.enter("listItemPrefix"), 42 === b || 45 === b ? a.check(bv, c, h)(b) : h(b)
                );
              if (!d.interrupt || 49 === b)
                return (
          ...
          function k(c) {
            return (
              (d.containerState.size = f + d.sliceSerialize(a.exit("listItemPrefix"), !0).length),
              b(c)
            );
          }
        },
      ...
      bx = {
        ...
        tokenize: function (a, b, c) {
          ...
          return aL(
            ...
            function (a) {
              let e = d.events[d.events.length - 1];
              return !aH(a) && e && "listItemPrefixWhitespace" === e[1].type ? b(a) : c(a);
            },
      ...
      bz = {
        ...
        tokenize: function (a, b, c) {
          ...
          function f(d) {
            return null === d || aF(d) ? (a.exit("setextHeadingLine"), b(d)) : c(d);
          }
        },
      };
    a.s(
        ...
        0,
        {
          91: {
            ...
            tokenize: function (a, b, c) {
              ...
              function f(b) {
                return ((d = bi(e.sliceSerialize(e.events[e.events.length - 1][1]).slice(1, -1))),
                58 === b)
        ...
        0,
        {
          ...
          60: {
            ...
            tokenize: function (a, b, c) {
              ...
              function n(b) {
                return ay(b) ? (a.consume(b), (f = String.fromCharCode(b)), o) : c(b);
              }
              function o(g) {
                ...
                return 45 === g || az(g) ? (a.consume(g), (f += String.fromCharCode(g)), o) : c(g);
              }
              function p(d) {
              ...
              function s(b) {
                return 61 === b ? (a.consume(b), t) : aH(b) ? (a.consume(b), s) : q(b);
              }
              function t(b) {
              ...
              function x(b) {
                return null === b || aF(b) ? y(b) : aH(b) ? (a.consume(b), x) : c(b);
              }
              function y(b) {
                return 45 === b && 2 === d
                  ? (a.consume(b), C)
              ...
              function B(b) {
                return null === b || aF(b) ? z(b) : (a.enter("htmlFlowData"), y(b));
              }
              function C(b) {
              ...
              function H(b) {
                return null === b || aF(b) ? (a.exit("htmlFlowData"), I(b)) : (a.consume(b), H);
              }
              function I(c) {
          ...
          60: [
            {
              ...
              tokenize: function (a, b, c) {
                ...
                function h(b) {
                  return 64 === b ? (a.consume(b), i) : aA(b) ? (a.consume(b), h) : c(b);
                }
                function i(e) {
                  return az(e)
                    ? (function e(f) {
              ...
              tokenize: function (a, b, c) {
                ...
                function v(b) {
                  return 45 === b || az(b)
                    ? (a.consume(b), v)
                    : (function b(c) {
                        return aF(c) ? ((f = b), E(c)) : aH(c) ? (a.consume(c), b) : D(c);
                      })(b);
                }
                function w(b) {
                  return 45 === b || az(b)
    ...
    let bD = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
    function bE(a, b, c) {
      if (b) return b;
      ...
      if (a)
        throw Error(
          "Cannot close `" +
            a.type +
            "` (" +
            Z({ start: a.start, end: a.end }) +
            "): a different token (`" +
            b.type +
            "`, " +
            Z({ start: b.start, end: b.end }) +
            ") is open",
        );
      throw Error(
        ...
        return (
          ...
          (function (a) {
            let b = {
              ...
              exit: {
                ...
                autolinkProtocol: function (a) {
                  (k.call(this, a),
                    (this.stack[this.stack.length - 1].url = this.sliceSerialize(a)));
                },
                blockQuote: g(),
                ...
                characterReferenceValue: function (a) {
                  ...
                  d
                    ? ((b = bC(c, "characterReferenceMarkerNumeric" === d ? 10 : 16)),
                ...
                definitionLabelString: function (a) {
                  ...
                  ((c.label = b), (c.identifier = bi(this.sliceSerialize(a)).toLowerCase()));
                },
                ...
                labelText: function (a) {
                  ...
                  ((c.label = b.replace(bD, bE)), (c.identifier = bi(b).toLowerCase()));
                },
                lineEnding: function (a) {
                  let c = this.stack[this.stack.length - 1];
                  if (this.data.atHardBreak) {
                    ((c.children[c.children.length - 1].position.end = bG(a.end)),
            ...
            return function (a) {
                        ...
                        for (; ++h <= c; ) {
                          ...
                          switch (b[1].type) {
                            ...
                            case "lineEndingBlank":
                              "enter" === b[0] && (!d || g || i || f || (f = h), (g = void 0));
                              break;
                            case "linePrefix":
                            case "listItemValue":
                            case "listItemMarker":
                          ...
                          if (
                            ...
                            (-1 === i &&
                              "exit" === b[0] &&
                              ("listUnordered" === b[1].type || "listOrdered" === b[1].type))
                          ) {
                            if (d) {
                              let g = h;
                              for (e = void 0; g--; ) {
                                let b = a[g];
                                if ("lineEnding" === b[1].type || "lineEndingBlank" === b[1].type) {
                              ...
                              (f && (!e || f < e) && (d._spread = !0),
                                (d.end = Object.assign({}, e ? a[e][1].start : b[1].end)),
              ...
              for (
                d.position = {
                  start: bG(a.length > 0 ? a[0][1].start : { line: 1, column: 1, offset: 0 }),
                  end: bG(
                    a.length > 0 ? a[a.length - 2][1].end : { line: 1, column: 1, offset: 0 },
                  ),
                },
                  k = -1;
            ...
            function h(a, b) {
              ...
              if (d)
                d[0].type !== a.type &&
                  (b ? b.call(this, a, d[0]) : (d[1] || bH).call(this, a, d[0]));
              else
                throw Error(
                  "Cannot close `" +
                    a.type +
            ...
            function j(a) {
              let b = this.stack[this.stack.length - 1].children,
                c = b[b.length - 1];
              ((c && "text" === c.type) ||
                (((c = { type: "text", value: "" }).position = { start: bG(a.start), end: void 0 }),
                b.push(c)),
                this.stack.push(c));
            }
            function k(a) {
              let b = this.stack.pop();
              ((b.value += this.sliceSerialize(a)), (b.position.end = bG(a.end)));
            }
            function l() {
                    ...
                    return (function (a, b, c) {
                      let d = {
                        ...
                        i = {
                          ...
                          consume: function (a) {
                            (aF(a)
                              ? (d.line++, (d.column = 1), (d.offset += -3 === a ? 2 : 1), q())
                          ...
                          write: function (a) {
                            ...
                            (function () {
                              ...
                              for (; d._index < g.length; ) {
                                ...
                                if ("string" == typeof c)
                                  for (
                                    a = d._index, d._bufferIndex < 0 && (d._bufferIndex = 0);
                            ...
                            null !== g[g.length - 1])
                              ? []
                              : (p(b, 0), (j.events = a1(f, j.events, j)), j.events);
                          },
                        },
                      ...
                      function p(a, b) {
                        (a.resolveAll && !f.includes(a) && f.push(a),
                          a.resolve &&
                            au(j.events, b, j.events.length - b, a.resolve(j.events.slice(b), j)),
                ...
                .write(
                  ...
                  function (a, b, c) {
                    ...
                    for (
                      ...
                      if (
                        ((bB.lastIndex = j),
                        (k = (d = bB.exec(a)) && void 0 !== d.index ? d.index : a.length),
                        (l = a.charCodeAt(k)),
                        !d)
                      ) {
                        h = a.slice(j);
    ...
    let bJ = "object" == typeof self ? self : globalThis,
          ...
          (h = (a) => {
            ...
            switch (b) {
              ...
              case 2: {
                ...
                let f = [],
                  i = g([b, f], a);
                for (let b of bM(a)) (d || !bO(bN(a[b]))) && f.push([h(b), h(a[b])]);
                return i;
              }
              case 3:
              ...
              case 5: {
                let c = [],
                  e = g([b, c], a);
                for (let [b, e] of a) (d || !(bO(bN(b)) || bO(bN(e)))) && c.push([h(b), h(e)]);
                return e;
              }
              case 6: {
                let c = [],
      ...
      bQ =
        "function" == typeof structuredClone
          ? (a, b) => (b && ("json" in b || "lossy" in b) ? bK(bP(a, b)) : structuredClone(a))
          : (a, b) => bK(bP(a, b));
    function bR(a) {
      let b = [],
        c = -1,
      ...
      for (; ++c < a.length; ) {
        let f = a.charCodeAt(c),
          g = "";
        if (37 === f && az(a.charCodeAt(c + 1)) && az(a.charCodeAt(c + 2))) e = 2;
        else if (f < 128)
          /[!#$&-;=?-Z_a-z~]/.test(String.fromCharCode(f)) || (g = String.fromCharCode(f));
        ...
        (g && (b.push(a.slice(d, c), encodeURIComponent(g)), (d = c + e + 1), (g = "")),
          e && ((c += e), (e = 0)));
      }
    ...
    function bY(a, b, c, d) {
      ...
      (function a(e, h, i) {
        ...
        if ("string" == typeof j.type) {
          let a =
            "string" == typeof j.tagName ? j.tagName : "string" == typeof j.name ? j.name : void 0;
    ...
    let b1 = {
      ...
      footnoteReference: function (a, b) {
        let c,
          d =
            "string" == typeof a.options.clobberPrefix ? a.options.clobberPrefix : "user-content-",
      ...
      table: function (a, b) {
        ...
        if (c.length > 0) {
          let d = { type: "element", tagName: "tbody", properties: {}, children: a.wrap(c, !0) },
            f = X(b.children[1]),
            g = W(b.children[b.children.length - 1]);
        ...
        let c = {
          ...
          value: (function (a) {
            let b = String(a),
              ...
              f = [];
            for (; d; )
              (f.push(b0(b.slice(e, d.index), e > 0, !0), d[0]),
                (e = d.index + d[0].length),
                (d = c.exec(b)));
            return (f.push(b0(b.slice(e), e > 0, !1)), f.join(""));
          })(String(b.value)),
        };
        return (a.patch(b, c), a.applyData(b, c));
      },
      ...
      yaml: b2,
      definition: b2,
      footnoteDefinition: b2,
    };
    function b2() {}
    let b3 = {}.hasOwnProperty,
      b4 = {};
    function b5(a, b) {
      a.position &&
    ...
    function b9(a, b) {
      let c,
        ...
        h =
          ...
          (f = {
                ...
                for (; ++d < c.length; ) {
                  ...
                  if (e) {
                    if (
                      d &&
                      "break" === c[d - 1].type &&
                      (Array.isArray(e) || "text" !== e.type || (e.value = b8(e.value)),
                      !Array.isArray(e) && "element" === e.type)
                    ) {
                      let a = e.children[0];
                      a && "text" === a.type && (a.value = b8(a.value));
                    }
            ...
            footnoteOrder: [],
            handlers: { ...b1, ...c.handlers },
            one: function (a, b) {
              let c = a.type,
                d = f.handlers[c];
              if (b3.call(f.handlers, c) && d) return d(f, a, b);
              ...
              return (
                ...
                function (a, b) {
                  let c = b.data || {},
                    d =
                      "value" in b && !(b3.call(c, "hProperties") || b3.call(c, "hChildren"))
                        ? { type: "text", value: b.value }
                        : { type: "element", tagName: "div", properties: {}, children: a.all(b) };
                  return (a.patch(b, d), a.applyData(b, d));
                }
              )(f, a, b);
            },
      ...
      return (j && (g("children" in k), k.children.push({ type: "text", value: "\n" }, j)), k);
    }
    function ca(a, b) {
      return a && "run" in a
        ? async function (c, d) {
    ...
    let ci = ["history", "path", "basename", "stem", "extname", "dirname"];
    class cj {
      constructor(a) {
        let b, c;
        ((b = a
          ? ch(a)
            ...
            : "string" == typeof a ||
              ...
              : a
          : {}),
          (this.cwd = "cwd" in b ? "" : cf.default.cwd()),
          (this.data = {}),
          (this.history = []),
          (this.messages = []),
          this.value,
        ...
        for (c in b) ci.includes(c) || (this[c] = b[c]);
      }
      get basename() {
        return "string" == typeof this.path ? ce.default.basename(this.path) : void 0;
      }
      set basename(a) {
        (cl(a, "basename"),
          ck(a, "basename"),
          (this.path = ce.default.join(this.dirname || "", a)));
      }
      get dirname() {
        return "string" == typeof this.path ? ce.default.dirname(this.path) : void 0;
      }
      set dirname(a) {
        (cm(this.basename, "dirname"), (this.path = ce.default.join(a || "", this.basename)));
      }
      get extname() {
        return "string" == typeof this.path ? ce.default.extname(this.path) : void 0;
      }
      set extname(a) {
        if ((ck(a, "extname"), cm(this.dirname, "extname"), a)) {
        ...
        this.path = ce.default.join(this.dirname, this.stem + (a || ""));
      }
      get path() {
        return this.history[this.history.length - 1];
      }
      set path(a) {
        (ch(a) && (a = (0, cg.fileURLToPath)(a)),
          cl(a, "path"),
          this.path !== a && this.history.push(a));
      }
      get stem() {
        return "string" == typeof this.path ? ce.default.basename(this.path, this.extname) : void 0;
      }
      set stem(a) {
        (cl(a, "stem"),
          ck(a, "stem"),
          (this.path = ce.default.join(this.dirname || "", a + (this.extname || ""))));
      }
      fail(a, b, c) {
    ...
    function ck(a, b) {
      if (a && a.includes(ce.default.sep))
        throw Error("`" + b + "` cannot be a path: did not expect `" + ce.default.sep + "`");
    }
    function cl(a, b) {
    ...
    class cp extends cn {
      ...
      copy() {
        ...
        return (a.data((0, cc.default)(!0, {}, this.namespace)), a);
      }
      data(a, b) {
        return "string" == typeof a
          ? 2 == arguments.length
            ? (ct("data", this.frozen), (this.namespace[a] = b), this)
            : (co.call(this.namespace, a) && this.namespace[a]) || void 0
          : a
            ? (ct("data", this.frozen), (this.namespace = a), this)
            : this.namespace;
      }
      freeze() {
      ...
      parse(a) {
        ...
        return (cr("parse", c), c(String(b), b));
      }
      process(a, b) {
        let c = this;
        return (
          this.freeze(),
          cr("process", this.parser || this.Parser),
          cs("process", this.compiler || this.Compiler),
        ...
        function d(d, e) {
          ...
          function i(a, c) {
            a || !c
              ...
              : d
                ? d(c)
                : (g(b, "`done` is defined if `resolve` is not"), b(void 0, c));
          }
          c.run(h, f, function (a, b, d) {
            var e, f;
            if (a || !b || !d) return i(a);
      ...
      processSync(a) {
        ...
        return (
          this.freeze(),
          cr("processSync", this.parser || this.Parser),
          cs("processSync", this.compiler || this.Compiler),
          this.process(a, function (a, d) {
            ((c = !0), cb(a), (b = d));
          }),
          cv("processSync", "process", c),
          g(b, "we either bailed on an error or have a tree"),
          b
        );
      }
      run(a, b, c) {
        ...
        return (
          c || "function" != typeof b || ((c = b), (b = void 0)), c ? e(void 0, c) : new Promise(e)
        );
        function e(e, f) {
          g("function" != typeof b, "`file` can’t be a `done` anymore, we checked");
          let h = cw(b);
          d.run(a, h, function (b, d, h) {
            let i = d || a;
            b ? f(b) : e ? e(i) : (g(c, "`done` is defined if `resolve` is not"), c(void 0, i, h));
          });
        }
      }
      runSync(a, b) {
        ...
        return (
          ...
          cv("runSync", "run", d),
          g(c, "we either bailed on an error or have a tree"),
          c
        );
      }
      stringify(a, b) {
        ...
        return (cs("stringify", d), cu(a), d(a, c));
      }
      use(a, ...b) {
        let c = this.attachers,
          d = this.namespace;
        if ((ct("use", this.frozen), null == a));
        ...
        function e(a) {
          ...
          (f(a.plugins), a.settings && (d.settings = (0, cc.default)(!0, d.settings, a.settings)));
        }
        function f(a) {
          let b = -1;
          if (null == a);
        ...
        function g(a, b) {
          ...
          if (-1 === e) c.push([a, ...b]);
            ...
            let [d, ...f] = b,
              g = c[e][1];
            (cd(g) && cd(d) && (d = (0, cc.default)(!0, g, d)), (c[e] = [a, d, ...f]));
          }
        }
      }
    }
    let cq = new cp().freeze();
    function cr(a, b) {
    ...
    function cu(a) {
      if (!cd(a) || "string" != typeof a.type) throw TypeError("Expected node, got `" + a + "`");
    }
    function cv(a, b, c) {
    ...
    function cw(a) {
      var b;
      return (b = a) && "object" == typeof b && "message" in b && "messages" in b ? a : new cj(a);
    }
    let cx = [],
      cy = { allowDangerousHtml: !0 },
      cz = /^(https?|ircs?|mailto|xmpp)$/i,
      cA = [
    ...
    function cB(a) {
      ...
      let d,
        ...
        i,
        j =
          ((d = (c = a).rehypePlugins || cx),
          (e = c.remarkPlugins || cx),
          (f = c.remarkRehypeOptions ? { ...c.remarkRehypeOptions, ...cy } : cy),
          cq().use(bI).use(e).use(ca, f).use(d)),
        k =
          ((g = a.children || ""),
          (i = new cj()),
          "string" == typeof g
            ? (i.value = g)
            : h("Unexpected value `" + g + "` for `children` prop, expected `string`"),
          i);
      return (function (a, c) {
        ...
        return (
          ...
          bZ(a, function (a, b, c) {
            if ("raw" === a.type && c && "number" == typeof b)
              return (
                i ? c.children.splice(b, 1) : (c.children[b] = { type: "text", value: a.value }), b
              );
            if ("element" === a.type) {
              let b;
              for (b in ap)
                if (Object.hasOwn(ap, b) && Object.hasOwn(a.properties, b)) {
    ...
    function cJ(a) {
      ...
      let b = this.stack[this.stack.length - 1];
      (g("link" === b.type), (b.url = "http://" + this.sliceSerialize(a)));
    }
    function cK(a) {
    ...
    function cN(a, b, c, d, e) {
      ...
      let h = (function (a) {
        ...
        let c = b[0],
          ...
          f = cD(a, ")");
        for (; -1 !== d && e > f; )
          ((a += c.slice(0, d + 1)), (d = (c = c.slice(d + 1)).indexOf(")")), f++);
        return [a, c];
      })(c + d);
      if (!h[0]) return !1;
      let i = {
    ...
    function cP(a, b) {
      ...
      return (0 === a.index || aJ(c) || aI(c)) && (!b || 47 !== c);
    }
    function cQ() {
      this.buffer();
    }
    ...
    function c2(a, b, c, d) {
      let e = c.createTracker(d),
        ...
        g = e.move("~~");
      return (
        (g += c.containerPhrasing(a, { ...e.current(), before: g, after: "~" })),
        (g += e.move("~~")),
        f(),
        g
      );
    ...
    function dc(a) {
      let b = this.resume();
      this.data.inTable && (b = b.replace(/\\([\\|])/g, dd));
      let c = this.stack[this.stack.length - 1];
      (g("inlineCode" === c.type), (c.value = b), this.exit(a));
    }
    function dd(a, b) {
      return "|" === b ? b : a;
    }
    function de(a) {
      ...
      (g("listItem" === b.type), (b.checked = "taskListCheckValueChecked" === a.type));
    }
    function df(a) {
      let b = this.stack[this.stack.length - 2];
    ...
    let dh = {
          ...
          function d(g) {
            return 33 === g ||
              ...
              : 38 === g
                ...
                : 93 === g
                  ? (a.consume(g), e)
                  : 60 === g || null === g || aG(g) || aJ(g)
                    ? b(g)
                    : c(g);
          }
          function e(a) {
            return null === a || 40 === a || 91 === a || aG(a) || aJ(a) ? b(a) : d(a);
          }
          function f(b) {
            return ay(b)
              ? (function b(e) {
                  return 59 === e ? (a.consume(e), d) : ay(e) ? (a.consume(e), b) : c(e);
                })(b)
              : c(b);
          }
        },
      ...
      dm = {
        ...
        tokenize: function (a, b, c) {
          let d = this;
          return function (b) {
            return (87 !== b && 119 !== b) || !ds.call(d, d.previous) || dw(d.events)
              ? c(b)
              : (a.enter("literalAutolink"),
                a.enter("literalAutolinkWww"),
                a.check(dh, a.attempt(di, a.attempt(dj, e), c), c)(b));
          };
          function e(c) {
      ...
      dn = {
        ...
        tokenize: function (a, b, c) {
          let d = this,
            ...
            f = !1;
          return function (b) {
            return (72 === b || 104 === b) && dt.call(d, d.previous) && !dw(d.events)
              ? (a.enter("literalAutolink"),
          ...
          function g(b) {
            if (ay(b) && e.length < 5) return ((e += String.fromCodePoint(b)), a.consume(b), g);
            if (58 === b) {
              let c = e.toLowerCase();
          ...
          function i(b) {
            return null === b || aB(b) || aG(b) || aJ(b) || aI(b)
              ? c(b)
              : a.attempt(di, a.attempt(dj, j), c)(b);
          }
          function j(c) {
      ...
      dp = {
        ...
        tokenize: function (a, b, c) {
          let d,
            ...
            f = this;
          return function (b) {
            return !dv(b) || !du.call(f, f.previous) || dw(f.events)
              ? c(b)
              : (a.enter("literalAutolink"),
                a.enter("literalAutolinkEmail"),
                (function b(d) {
                  return dv(d) ? (a.consume(d), b) : 64 === d ? (a.consume(d), g) : c(d);
                })(b));
          };
          function g(b) {
            return 46 === b
      ...
      dq = {},
      dr = 48;
    for (; dr < 123; ) ((dq[dr] = dp), 58 == ++dr ? (dr = 65) : 91 === dr && (dr = 97));
    function ds(a) {
      return (
        null === a || 40 === a || 42 === a || 95 === a || 91 === a || 93 === a || 126 === a || aG(a)
      );
    }
    function dt(a) {
      return !ay(a);
    ...
    function dv(a) {
      return 43 === a || 45 === a || 46 === a || 95 === a || az(a);
    }
    function dw(a) {
      let b = a.length,
        c = !1;
    ...
    function dy(a, b, c) {
      ...
      return function (f) {
        ...
        let h = bi(e.sliceSerialize({ start: d.end, end: e.now() }));
    ...
    function dA(a, b, c) {
      ...
      function i(h) {
        if (g > 999 || (93 === h && !d) || null === h || 91 === h || aG(h)) return c(h);
        if (93 === h) {
          a.exit("chunkString");
          let d = a.exit("gfmFootnoteCallString");
          return f.includes(bi(e.sliceSerialize(d)))
            ? (a.enter("gfmFootnoteCallLabelMarker"),
              a.consume(h),
              a.exit("gfmFootnoteCallLabelMarker"),
        ...
        return (aG(h) || (d = !0), g++, a.consume(h), 92 === h ? j : i);
      }
      function j(b) {
    ...
    function dB(a, b, c) {
      ...
      function j(b) {
        if (h > 999 || (93 === b && !e) || null === b || 91 === b || aG(b)) return c(b);
        if (93 === b) {
          a.exit("chunkString");
          let c = a.exit("gfmFootnoteDefinitionLabelString");
          return (
            (d = bi(f.sliceSerialize(c))),
            a.enter("gfmFootnoteDefinitionLabelMarker"),
            a.consume(b),
            a.exit("gfmFootnoteDefinitionLabelMarker"),
        ...
        return (aG(b) || (e = !0), h++, a.consume(b), 92 === b ? k : j);
      }
      function k(b) {
      ...
      function l(b) {
        return 58 === b
          ? (a.enter("definitionMarker"),
            ...
            aL(a, m, "gfmFootnoteDefinitionWhitespace"))
          : c(b);
      }
      function m(a) {
        return b(a);
    ...
    function dC(a, b, c) {
      return a.check(aP, b, a.attempt(dx, b, c));
    }
    function dD(a) {
    ...
    function dF(a, b, c) {
      ...
      function h(b) {
        var c;
        return (
          a.enter("tableHead"), a.enter("tableRow"), 124 === (c = b) || ((d = !0), (g += 1)), i(c)
        );
      }
      function i(b) {
        return null === b
      ...
      function l(b) {
        return ((e.interrupt = !1), e.parser.lazy[e.now().line])
          ? c(b)
          : (a.enter("tableDelimiterRow"), (d = !1), aH(b))
            ? aL(
                a,
                m,
                "linePrefix",
      ...
      function n(b) {
        return aH(b) ? aL(a, o, "whitespace")(b) : o(b);
      }
      function o(b) {
        return 58 === b
          ? ((g += 1),
      ...
      function q(b) {
        return aH(b) ? aL(a, r, "whitespace")(b) : r(b);
      }
      function r(e) {
        if (124 === e) return m(e);
        if (null === e || aF(e))
    ...
    function dG(a, b) {
            ...
            : "tableRow" === o.type || "tableDelimiterRow" === o.type
              ...
              : h &&
                ...
                ? ((g = !1),
                  0 === j[2] &&
                    (0 !== i[1] &&
                      ((j[0] = j[1]), (e = dH(m, b, i, h, void 0, e)), (i = [0, 0, 0, 0])),
                    (j[2] = f)))
                : "tableCellDivider" === o.type &&
                  (g
                    ? (g = !1)
                    : (0 !== i[1] && ((j[0] = j[1]), (e = dH(m, b, i, h, void 0, e))),
                      (j = [(i = j)[1], f, 0, 0])))
          : "tableHead" === o.type
            ? ((k = !0), (l = f))
            : "tableRow" === o.type || "tableDelimiterRow" === o.type
              ? ((l = f),
                0 !== i[1]
                  ? ((j[0] = j[1]), (e = dH(m, b, i, h, f, e)))
                  : 0 !== j[1] && (e = dH(m, b, j, h, f, e)),
                (h = 0))
              : h &&
                ("data" === o.type ||
                  "tableDelimiterMarker" === o.type ||
      ...
      for (0 !== l && dI(m, b, l, c, d), m.consume(b.events), f = -1; ++f < b.events.length; ) {
        let a = b.events[f];
        "enter" === a[0] &&
          "table" === a[1].type &&
    ...
    function dH(a, b, c, d, e, f) {
      0 !== c[0] &&
        ((f.end = Object.assign({}, dJ(b.events, c[0]))), a.add(c[0], 0, [["exit", f, b]]));
      let g = dJ(b.events, c[1]);
      if (
        ((f = {
      ...
      return (
        void 0 !== e &&
          ((f.end = Object.assign({}, dJ(b.events, e))),
          a.add(e, 0, [["exit", f, b]]),
          (f = void 0)),
        f
      );
    ...
    let dK = {
      ...
      tokenize: function (a, b, c) {
        ...
        function g(d) {
          return aF(d) ? b(d) : aH(d) ? a.check({ tokenize: dL }, b, c)(d) : c(d);
        }
      },
    };
    function dL(a, b, c) {
    ...
    function dN(a) {
      ...
      (g.push(
        ax([
          { text: dq },
          {
            document: {
              91: {
                ...
                tokenize: dB,
                continuation: { tokenize: dC },
                exit: dD,
              },
            },
            text: {
              91: { name: "gfmFootnoteCall", tokenize: dA },
              93: { name: "gfmPotentialFootnoteCall", add: "after", tokenize: dy, resolveTo: dz },
            },
          },
          ((b = (e || {}).singleTilde),
          (c = {
                ...
                if (
                  ...
                  for (; d--; )
                    if (
                      ...
                      (h && au(g, g.length, 0, a1(h, a.slice(d + 1, c), b)),
                        au(g, g.length, 0, [
                          ["exit", f, b],
                          ["enter", a[c][1], b],
                          ["exit", a[c][1], b],
          ...
          { flow: { null: { name: "table", tokenize: dF, resolveAll: dG } } },
          { text: { 91: dK } },
        ]),
      ),
        h.push([
          {
            ...
            exit: {
              literalAutolink: cL,
              literalAutolinkEmail: cK,
              literalAutolinkHttp: cI,
              literalAutolinkWww: cJ,
            },
          },
          {
            enter: {
              gfmFootnoteCallString: cQ,
              gfmFootnoteCall: cR,
            ...
            exit: {
              ...
              gfmFootnoteCall: cV,
              gfmFootnoteDefinitionLabelString: cW,
              gfmFootnoteDefinition: cX,
            },
          },
          { canContainEols: ["delete"], enter: { strikethrough: c0 }, exit: { strikethrough: c1 } },
          {
            enter: { table: c7, tableData: db, tableHeader: db, tableRow: c9 },
            exit: { codeText: dc, table: c8, tableData: da, tableHeader: da, tableRow: da },
          },
          {
            exit: { taskListCheckValueChecked: de, taskListCheckValueUnchecked: de, paragraph: df },
          },
        ]),
        i.push({
          extensions: [
                ...
                footnoteDefinition: function (a, b, c, e) {
                  ...
                  return (
                    ...
                    a.children &&
                      ...
                      (g += f.move(
                        (d ? "\n" : " ") +
                          c.indentLines(c.containerFlow(a, f.current()), d ? c$ : cZ),
                      ))),
                    h(),
                    g
                  );
                },
                footnoteReference: cY,
              },
              unsafe: [{ character: "[", inConstruct: ["label", "phrasing", "reference"] }],
            }),
            {
              unsafe: [{ character: "~", inConstruct: "phrasing", notInConstruct: c_ }],
              handlers: { delete: c2 },
            },
            (function (a) {
              let b = a || {},
              ...
              function h(a, b) {
                return (function (a, b) {
                  ...
                  let m = -1;
                  if ("object" == typeof d && "length" in d) for (; ++m < j; ) f[m] = c4(d[m]);
                  else {
                    let a = c4(d);
                    for (; ++m < j; ) f[m] = a;
                  }
                    ...
                    for (; ++m < j; ) {
                      ...
                      if (!1 !== c.alignDelimiters) {
                        ...
                        114 === c
                          ...
                          : 99 === c
                            ? a % 2
                              ? ((g = " ".repeat(a / 2 + 0.5)), (h = " ".repeat(a / 2 - 0.5)))
                              : (h = g = " ".repeat(a / 2))
                            : (h = " ".repeat(a));
                      }
    ...
    function dO({ content: a }) {
      return a.trim()
        ? (0, b.jsx)(cB, {
            remarkPlugins: [dN],
            components: {
              a: ({ href: a, children: c, ...d }) =>
                (0, b.jsx)("a", {
                  href: a,
                  target: "_blank",
    ...
    function dP({ prev: a, next: d }) {
      return a || d
        ? (0, b.jsxs)("nav", {
            className:
              "flex flex-col gap-4 border-t border-[var(--p-tan)] pt-8 sm:flex-row sm:justify-between",
              ...
              (0, b.jsx)("div", {
                ...
                children: a
                  ? (0, b.jsxs)(c.default, {
                      ...
                      className:
                        "group inline-flex items-center gap-2 text-sm font-medium text-[var(--p-toffee)] outline-none hover:underline focus-visible:ring-2 focus-visible:ring-[var(--p-toffee)] focus-visible:ring-offset-2",
                      children: [
                        (0, b.jsx)("span", { "aria-hidden": !0, children: "←" }),
                        (0, b.jsx)("span", { className: "truncate", children: a.title }),
                      ],
                    })
                  : (0, b.jsx)("span", {}),
              }),
              (0, b.jsx)("div", {
                ...
                children: d
                  ? (0, b.jsxs)(c.default, {
                      ...
                      className:
                        "group inline-flex items-center gap-2 text-sm font-medium text-[var(--p-toffee)] outline-none hover:underline focus-visible:ring-2 focus-visible:ring-[var(--p-toffee)] focus-visible:ring-offset-2 sm:justify-end",
                      children: [
                        (0, b.jsx)("span", { className: "truncate", children: d.title }),
                        (0, b.jsx)("span", { "aria-hidden": !0, children: "→" }),
                      ],
                    })
                  : (0, b.jsx)("span", {}),
    ...
    async function dQ({ params: a }) {
      let { slug: b } = await a,
        c = null;
      try {
        c = await e.client.project.getBySlug({ slug: b });
      } catch {
        return { title: "Not found" };
      }
      if (!c) return { title: "Not found" };
      let d = c.description.slice(0, 160).replace(/\s+/g, " ").trim();
      return {
        title: c.title,
        description: d ? d + (c.description.length > 160 ? "…" : "") : void 0,
      };
    }
    async function dR({ params: a }) {
      let { slug: g } = await a,
        h = null,
        i = [];
      try {
        [h, i] = await Promise.all([
          e.client.project.getBySlug({ slug: g }),
          e.client.project.list(),
        ]);
      } catch {
        (0, d.notFound)();
      }
      h || (0, d.notFound)();
      let j = i.findIndex((a) => a.slug === g),
        k = j > 0 ? i[j - 1] : null,
        l = j >= 0 && j < i.length - 1 ? i[j + 1] : null,
        m = [];
      for (let a of (h.featuredImageUrl && m.push(h.featuredImageUrl), h.images ?? []))
        a.url && !m.includes(a.url) && m.push(a.url);
      return (0, b.jsx)("div", {
        ...
        children: (0, b.jsxs)("article", {
          ...
          children: [
            (0, b.jsx)(f.ProjectCarousel, { urls: m, className: "mb-8 aspect-4/3 w-full" }),
            (0, b.jsxs)("header", {
              className: "mb-8",
              children: [
                (0, b.jsx)("div", {
                ...
                (0, b.jsx)("h1", {
                  className:
                    "text-3xl font-bold tracking-tight text-balance text-[var(--p-deep-walnut)] md:text-4xl",
                  children: h.title,
                }),
              ],
            }),
            (0, b.jsx)("div", {
              className:
                "prose prose-neutral max-w-none text-pretty text-[var(--p-coffee-bean)] prose-headings:text-[var(--p-deep-walnut)] prose-a:text-[var(--p-toffee)]",
              children: (0, b.jsx)(dO, { content: h.description }),
            }),
            (0, b.jsx)(dP, {
              prev: k ? { slug: k.slug, title: k.title } : null,
              next: l ? { slug: l.slug, title: l.title } : null,
            }),
            (0, b.jsx)("div", {
              className: "mt-10",
              children: (0, b.jsxs)(c.default, {
                href: "/projects",
                className:
                  "inline-flex items-center gap-2 text-sm font-medium text-[var(--p-toffee)] outline-none hover:underline focus-visible:ring-2 focus-visible:ring-[var(--p-toffee)] focus-visible:ring-offset-2",
                children: [
                  (0, b.jsx)("span", {
    ...
    a.s(["default", () => dR, "generateMetadata", () => dQ], 61578);
  },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__edd65c30._.js.map
