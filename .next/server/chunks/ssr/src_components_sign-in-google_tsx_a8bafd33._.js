  ...
  (a) => {
    ...
    function h() {
      return (0, b.jsx)("div", {
        ...
        children: (0, b.jsx)(g.default, { className: "animate-spin" }),
      });
    }
    let i = () =>
      (0, b.jsxs)("svg", {
    ...
    function j() {
      let a = (0, d.useRouter)(),
        { data: g, isPending: j } = f.authClient.useSession();
      return ((0, c.useEffect)(() => {
        g?.user && a.replace("/cms/projects");
      }, [g, a]),
      j || g?.user)
        ? (0, b.jsx)("div", {
                  ...
                  children: [
                    ...
                    (0, b.jsx)("div", {
                      ...
                      children: (0, b.jsxs)("button", {
                        type: "button",
                        onClick: () => {
                          f.authClient.signIn.social(
                            { provider: "google", callbackURL: "/cms/projects" },
                            {
                              onError: (a) => {
                                e.toast.error(
                                  a.error?.message ?? a.error?.statusText ?? "Sign in failed",
                                );
                              },
                            },
                          );
                        ...
                        children: [(0, b.jsx)(i, {}), "Continue with Google"],
                      }),
                    }),
                    (0, b.jsx)("p", {
...
//# sourceMappingURL=src_components_sign-in-google_tsx_a8bafd33._.js.map
