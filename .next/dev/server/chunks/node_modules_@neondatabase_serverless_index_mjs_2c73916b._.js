...
a multiple of 4",
      ...
      function Ro(r) {
        ...
        return (
          i === 2 &&
            ((e = (te[r.charCodeAt(c)] << 2) | (te[r.charCodeAt(c + 1)] >> 4)), (s[o++] = e & 255)),
          i === 1 &&
            ((e =
...
codeChunk",
    ...
    var ii = T((Re) => {
      ...
      !h.TYPED_ARRAY_SUPPORT &&
        ...
        console.error(
          "This browser lacks typed array (Uint8Array) su\
...
ounds',
      ...
      function Gt(r) {
        if (r >= ft)
          throw new RangeError(
            "Attempt to allocate Buffer larger t\
han maximum size: 0x" +
              ft.toString(16) +
              " bytes",
          );
        ...
        for (; i < t; ) {
          ...
          if (i + u <= t) {
            ...
            switch (u) {
              ...
              case 2:
                ((c = r[i + 1]),
                  (c & 192) === 128 && ((y = ((s & 31) << 6) | (c & 63)), y > 127 && (o = y)));
                break;
              case 3:
                ((c = r[i + 1]),
                  (l = r[i + 2]),
          ...
          (o === null
            ? ((o = 65533), (u = 1))
            : o > 65535 &&
              ((o -= 65536), n.push(((o >>> 10) & 1023) | 55296), (o = 56320 | (o & 1023))),
            n.push(o),
            (i += u));
        }
        return zo(n);
...
f range.`,
          ...
          return (
            Number.isInteger(t) && Math.abs(t) > 2 ** 32
              ...
              : typeof t == "bigint" &&
                ((i = String(t)),
                (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (i = $n(i)),
                (i += "n")),
            (n += ` It must be ${e}. Re\
ceived ${i}`),
            n
      ...
      function je(r, e, t) {
        throw Math.floor(r) !== r
          ...
          : e < 0
            ...
            : new Te.ERR_OUT_OF_RANGE(t || "offset", `>= ${t ? 1 : 0} and <= ${e}`, r);
      }
      a(je, "boundsError");
      ...
      Object.defineProperty(B, "defaultMaxListeners", {
        ...
        set: a(function (r) {
          if (typeof r != "number" || r < 0 || ai(r))
            throw new RangeError(
              'The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' +
                r +
                ".",
            );
          oi = r;
      ...
      B.prototype.setMaxListeners = a(function (e) {
        if (typeof e != "number" || e < 0 || ai(e))
          throw new RangeError(
            'Th\
e value of "n" is out of range. It must be a non-negative number. Received ' +
              e +
              ".",
          );
        ...
        if (
          ...
          s === void 0
            ...
            : (s.newListener !== void 0 &&
                (r.emit("newListener", e, t.listener ? t.listener : t), (s = r._events)),
              (o = s[e])),
          o === void 0)
        )
          ((o = s[e] = t), ++r._eventsCount);
        else if (
          (typeof o == "function" ? (o = s[e] = n ? [t, o] : [o, t]) : n ? o.unshift(t) : o.push(t),
          (i = ui(r)),
...
rap",
      ...
      B.prototype.prependOnceListener = a(
        function (e, t) {
...
trict";
        ...
        a(ha, "isIP");
        ((yi = /^[^.]+\./),
          (S = class S extends mi.EventEmitter {
            constructor() {
              super(...arguments);
              E(this, "opts", {});
              E(this, "connecting", !1);
...
writeBuffer",
            ...
            wsProxyAddrForHost(t, n) {
              ...
              if (i === void 0)
                throw new Error(
                  "No WebSocket proxy is configured. Please see https://github.c\
              ...
              try {
                ...
                fetch(f, {
                  ...
                  .catch((y) => {
                    (this.emit(
                      "error",
                      new Error(`All attempts to open a WebSocket to connect to the database failed. Please refer \
to https://github.com/neondatabase/serverless/blob/main/CONFIG.md#websocketconstructor-typeof-websoc\
ket--undefined. Details: ${y}`),
                    ),
                      this.emit("close"));
                  });
              }
        ...
        (a(S, "Socket"),
          E(S, "defaults", {
            ...
            fetchEndpoint: a((t, n, i) => {
              let s;
              return (
                i?.jwtAuth ? (s = t.replace(yi, "apiauth.")) : (s = t.replace(yi, "api.")),
                "https://" + s + "/sql"
              );
            }, "fetchEndpoint"),
        ...
        parse(e) {
          ...
          for (this.consumeDimensions(); !this.isEof(); )
            if (((t = this.nextCharacter()), t.value === "{" && !i))
              (this.dimension++,
                this.dimension > 1 &&
                  ((n = new vt(this.source.substr(this.position - 1), this.transform)),
...
ntity",
    ...
    var Ti = T((ef, Ii) => {
      "use strict";
      p();
      var Ia = /(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
        Ta = /^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,
        Pa = /([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,
        Ba = /^-?infinity$/;
            ...
            : r
                .map(function (e) {
                  ...
                  return (
                    e === "seconds" &&
                      this.milliseconds &&
                      (t = (t + this.milliseconds / 1e3).toFixed(6).replace(/\.?0+$/, "")),
                    t + " " + e
                  );
                }, this)
                .join(" ")
...
parseBigInteger",
    ...
    var Ki = T((bf, zi) => {
      ...
      var nu = Hi(),
        ...
        Ke = a(function (r) {
          for (
            var e = L(r, 32), t = L(r, 32, 32), n = L(r, 32, 64), i = 96, s = [], o = 0;
            o < e;
            o++
          )
...
t implemented: " + l,
        ...
        lu = a(function (r) {
          (r(20, nu),
            ...
            r(701, ou),
            r(16, cu),
            r(1114, Gi.bind(null, !1)),
            r(1184, Gi.bind(null, !0)),
            r(1e3, Ke),
            r(1007, Ke),
            r(1016, Ke),
            r(1008, Ke),
    ...
    function Xe(r) {
      let e = 1779033703,
        ...
        D = a(() => {
          ...
          for (let R = 16; R < 64; R++) {
            let j = g(A[R - 15], 7) ^ g(A[R - 15], 18) ^ (A[R - 15] >>> 3),
        ...
        P = a(() => {
          ...
          for (; f < 58; ) C[f++] = 0;
          let I = l * 8;
          ((C[f++] = (I / 1099511627776) & 255),
            (C[f++] = (I / 4294967296) & 255),
            (C[f++] = I >>> 24),
            (C[f++] = (I >>> 16) & 255),
            (C[f++] = (I >>> 8) & 255),
            (C[f++] = I & 255),
...
ength",
          ...
          start() {
            return (
              ...
              this._state.set(U.stateIdentity),
              this
            );
          }
          appendStr(e) {
            ...
            for (o = 0; o < e.length; o += 1) {
              ...
              i >= 64 &&
                ((this._dataLength += 64), U._md5cycle(this._state, n), (i -= 64), (n[0] = n[16]));
            }
          ...
          setState(e) {
            ...
            if (
              ((n[t] = 128),
              (n[t + 1] = n[t + 2] = n[t + 3] = 0),
              i.set(U.buffer32Identity.subarray(s), s),
              t > 55 && (U._md5cycle(this._state, i), i.set(U.buffer32Identity)),
              o <= 4294967295)
            )
              i[14] = o;
            else {
        ...
        (a(U, "Md5"),
          E(U, "stateIdentity", new Int32Array([1732584193, -271733879, -1732584194, 271733878])),
          E(
            U,
            "buffer32Identity",
...
L: SCRAM-SERVER-FIRST-MESSAGE: serverData must be a string",
        ...
        if (n.nonce.startsWith(r.clientNonce)) {
          if (n.nonce.length === r.clientNonce.length)
            throw new Error(
              "SASL: SCRAM-SERVER-FIRST-MESSAGE: server n\
once is too short",
            );
        } else
          throw new Error(
            "SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce does not st\
...
LResponse"),
      ...
      function Du(r, e) {
        ...
        if (t !== r.serverSignature)
          throw new Error(
            "SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does\
 not match",
          );
      }
...
ER-FIRST-MESSAGE: salt must be base64",
          ...
          throw new Error(
            "SASL: SCRAM-SERVER-FIRST-MESSAGE: salt\
 missing",
          );
        let i = e.get("i");
        if (i) {
          if (!/^[1-9][0-9]*$/.test(i))
            throw new Error(
              "SASL: SCRAM-SERVER-FI\
RST-MESSAGE: invalid iteration count",
            );
        } else
          throw new Error(
            "SASL: SCRAM-SERVER-FIRST-MESSAGE: itera\
tion missing",
          );
        let s = parseInt(i, 10);
        return {
      ...
      function Qu(r) {
        ...
        if (t) {
          if (!ls(t))
            throw new Error(
              "SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64",
            );
        } else
          throw new Error(
            "SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
...
ict";
    ...
    var vs = T((fh, bs) => {
      ...
      function zu(r, e, t) {
        ...
        if (
          ((this.overflow = this[ve].length > this.maxLength), this.overflow && !this.skipOverflow)
        ) {
          ...
          : Tt
            ...
            : ((e = e || "<unkn>"),
              ic(r.mode)
                ? r.mode & (ec | tc)
                  ? (Cr(
                      'WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',
                      e,
                    ),
                    !1)
                  : !0
                : (Cr('WARNING: password file "%s" is not a plain file', e), !1));
      };
            ...
            var e = {
                ...
                1: function (o) {
                  return o === "*"
                    ? !0
                    : ((o = Number(o)),
                      isFinite(o) && o > 0 && o < 9007199254740992 && Math.floor(o) === o);
                },
                2: function (o) {
                  return o.length > 0;
                },
    ...
    var Bt = T((Ah, Ls) => {
      ...
      var fc = (Is(), O(_s)),
        ...
        H = a(function (r, e, t) {
          return (
            t === void 0 ? (t = m.env["PG" + r.toUpperCase()]) : t === !1 || (t = m.env[t]),
            e[r] || t || Rs[r]
          );
        }, "val"),
        hc = a(function () {
        ...
        Br = class Br {
          constructor(e) {
            ((e = typeof e == "string" ? Bs(e) : e || {}),
              e.connectionString && (e = Object.assign({}, e, Bs(e.connectionString))),
              (this.user = H("user", e)),
...
t",
              ...
              (this.fallback_application_name = H("fallback_application_name", e, !1)),
              (this.statement_timeout = H("statement_timeout", e, !1)),
              (this.lock_timeout = H("lock_timeout", e, !1)),
...
ut",
              ...
              (this.query_timeout = H("query_timeout", e, !1)),
              ...
              typeof e.keepAliveInitialDelayMillis ==
                "nu\
...
slkey",
            ...
            (this.client_encoding && t.push("client_encoding=" + Oe(this.client_encoding)),
        ...
        Lr = class Lr {
          ...
          addFields(e) {
            ...
            for (var t = 0; t < e.length; t++) {
              var n = e[t];
              this._types
                ? (this._parsers[t] = this._types.getTypeParser(n.dataTypeID, n.format || "text"))
                : (this._parsers[t] = pc.getTypeParser(n.dataTypeID, n.format || "text"));
            }
          }
        };
      a(Lr, "Result");
        ...
        kr = class kr extends dc {
          ...
          submit(e) {
            ...
            return this.text && t && this.text !== t
              ? new Error(`Prepared statements must be unique - '${this.name}\
' was used for a different statement`)
              : this.values && !Array.isArray(this.values)
                ? new Error(
                    "Query val\
ues must be an array",
                  )
...
f-8",
        ...
        add(e) {
          return (
            this.ensure(e.length), e.copy(this.buffer, this.offset), (this.offset += e.length), this
          );
        }
        join(e) {
          if (e) {
...
ndSCRAMClientFinalMessage",
        ...
        xc = a((r) => {
          ...
          e.length > 63 &&
            ...
            console.error(
              "This can cause conflicts and silent errors e\
xecuting queries",
            ));
          let t = r.types || Ns,
            n = t.length,
...
writeValues",
        ...
        Pc = a(
          (r) => (r.name ? dn(68, `${r.type}${r.name || ""}`) : r.type === "P" ? Ic : Tc),
          "describe",
        ),
        Bc = a((r) => {
          let e = `${r.type}${r.name || ""}`;
...
e not supported yet",
          ...
          parse(e, t) {
            ...
            i === n
              ? ((this.buffer = $s), (this.bufferLength = 0), (this.bufferOffset = 0))
          ...
          mergeBuffer(e) {
            if (this.bufferLength > 0) {
              ...
              if (t + this.bufferOffset > this.buffer.byteLength) {
                ...
                (this.buffer.copy(i, 0, this.bufferOffset, this.bufferOffset + this.bufferLength),
                  (this.buffer = i),
                  (this.bufferOffset = 0));
              }
...
enticationOk message type " + i,
          ...
          parseErrorMessage(e, t, n, i) {
            ...
            let u = s.M,
              c = i === "notice" ? new k.NoticeMessage(t, u) : new k.DatabaseError(u, t, i);
            return (
              (c.severity = s.S),
              (c.code = s.C),
              (c.detail = s.D),
          ...
          connect(e, t) {
            ...
            ((this._connecting = !0),
              ...
              this.stream.once("connect", function () {
                (n._keepAlive && n.stream.setKeepAlive(!0, n._keepAliveInitialDelayMillis),
                  n.emit("connect"));
              }));
            let i = a(function (s) {
...
N":
                  return (
                    n.stream.end(),
                    n.emit("error", new Error("The server does not support SSL connections"))
                  );
                default:
                  return (
                    n.stream.end(),
                    n.emit("error", new Error("There was an error establishing an SSL connection"))
                  );
              }
              var u = (zs(), O(Vs));
              let c = {
              ...
              (n.ssl !== !0 && (Object.assign(c, n.ssl), "key" in n.ssl && (c.key = n.ssl.key)),
          ...
          _attachListeners(e) {
            (e.on("authenticationCleartextPassword", this._handleAuthCleartextPassword.bind(this)),
              ...
              e.on(
                "authentic\
ationSASL",
                this._handleAuthSASL.bind(this),
              ),
              ...
              this._queryable
                ? this._ending
                  ? (m.nextTick(() => {
                      i.handleError(
                        new Error(
                          "Client was closed and is not query\
able",
                        ),
                        this.connection,
                      );
...
l after calling end on the pool",
            ...
            t.connect((o) => {
              if ((i && clearTimeout(i), t.on("error", n), o))
                (this.log("client failed to connect", o),
                  ...
                  s &&
                    (o = new Error("Connection terminated due to connection timeout", {
                      cause: o,
                    })),
                  this._pulseQueue(),
                  ...
                  let u = setTimeout(() => {
                    (this.log("ending client due to expired lifetime"),
                      ...
                      this._idle.findIndex((l) => l.client === t) !== -1 &&
                        this._acquireClient(t, new Qe((l, f, y) => y()), n, !1));
        ...
        _release(e, t, n) {
          if (
            ...
            (e._poolUseCount >= this.options.maxUses && this.log("remove expended client"),
              this._remove(e),
              this._pulseQueue());
            return;
          }
          ...
          if (typeof e == "function") {
            ...
            return (
              v(function () {
                return s.callback(
                  new Error(
                    "Passing a function as the first parameter to pool.query is not supporte\
d",
                  ),
                );
              }),
              ...
              try {
                o.query(e, t, (l, f) => {
                  if ((this.log("query dispatched"), o.removeListener("error", c), !u))
                    return ((u = !0), o.release(l), l ? n(l) : n(void 0, f));
                });
              } catch (l) {
...
.com/brianc/node-postgres.git",
        ...
        author:
          "Brian Carlson <brian.m.carlson@gmail\
.com>",
        main: "./lib",
        dependencies: {
          "buffer-writer": "2.0.0",
...
b",
        ...
        gitHead:
          "c99fb2c127ddf8d712500db2c7b9a5491\
a178655",
      };
    });
    var lo = T((fp, co) => {
...
nd"),
        ...
        if ((m.domain && (t = m.domain.bind(t)), this.name)) {
          this.name.length > 63 &&
            (console.error(
              "Warning! Postgres only supports 63 characters for query n\
ames.",
            ),
...
red statements must be unique - '${this.name}' was used for a different statement`);
    ...
    var yo = T((yp, po) => {
      ...
      K.prototype._errorAllQueries = function (r) {
        ...
        (this._hasActiveQuery() && (e(this._activeQuery), (this._activeQuery = null)),
      ...
      K.prototype._connect = function (r) {
        ...
        if (this._connecting) {
          m.nextTick(() =>
            r(
              new Error(
                "Client has already been connected. You cannot reuse\
 a client.",
              ),
            ),
          );
...
n"
          ...
          ((s = this.connectionParameters.query_timeout), (n = new ho(r, e, t)), !n.callback)
        ) {
          let c, l;
          ...
          this._queryable
            ...
            : ((n.native = this.native),
              m.nextTick(() => {
                n.handleError(
                  new Error(
                    "Client has encountered a connectio\
...
stuvwxyz0123456789+/",
        ...
        for (let i = 0, s = t.length; i < s; i++)
          if (((e.query += t[i]), i < n.length)) {
            ...
            if (o instanceof Ge) e.query += o.sql;
              ...
              if (o.queryData instanceof gt) o.queryData.toParameterizedQuery(e);
              else {
    ...
    p();
    function bt() {
      ("TURBOPACK compile-time value", "undefined") < "u" &&
        typeof document < "u" &&
        typeof console < "u" &&
        typeof console.warn ==
          "func\
...
tackTrace" in Error &&
    ...
    var be = _t,
      is =
        "transaction() expects an array of queries, or a function returning a\
n array of queries",
      Ru = [
        "severity",
        "code",
...
areQuery",
    ...
    function cs(
      ...
      if (!r)
        throw new Error(
          "No database connection string was\
 provided to `neon()`. Perhaps an environment variable has not been set?",
      ...
      if ((f !== "postgres:" && f !== "postgresql:") || !y || !g || !C)
        throw new Error(
          "Database connection string format for `neon()` should be: postgresql://user:\
password@host.tld/dbname?option=value",
        );
      function D(P, ...I) {
        if (!(Array.isArray(P) && Array.isArray(P.raw) && Array.isArray(I)))
          throw new Error(
            'This function can now be called only as a tagged-template functio\
...
e",
        ...
        if (ye.ok) {
          ...
          if (Array.isArray(P)) {
            ...
            if (!Array.isArray(M))
              throw new be(
                "Neon internal error: unexpected resu\
lt format",
              );
            return M.map(($, me) => {
              let Ot = I[me] ?? {},
      ...
      let i = new as.default(n),
        ...
        u =
          e === !0
            ...
            : r.rows.map((c) =>
                Object.fromEntries(c.map((l, f) => [s[f], l === null ? null : o[f](l)])),
              );
      return t
        ? ((r.viaNeonFetch = !0),
          (r.rowAsArray = e),
    ...
    var kn = class kn extends wo.Client {
      ...
      connect(t) {
        ...
        (n.forceDisablePgSSL && (this.ssl = this.connection.ssl = !1),
          this.ssl &&
            n.useSecureWebSocket &&
            console.warn(
              "SSL is enabled for both Postgres (e.g. ?sslmode=re\
...
e SSL in the Postgres connection parameters or set forceDisablePgSSL = true.",
        ...
        let i =
            ...
            (typeof this.config != "string" && this.config?.connectionString !== void 0) ||
            m.env.PGHOST !== void 0,
        ...
        if (
          ...
          throw new Error(`No database host or connection string wa\
...
ot use SASL auth when `crypto.subtle` is not defined",
        ...
        if (!c || !/^[!-+--~]+$/.test(c))
          throw new Error(
            "SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce missing/unpri\
ntable",
          );
        ...
        if (c.length === i.clientNonce.length)
          throw new Error(
            "SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too\
 short",
          );
        let y = parseInt(f, 10),
          g = d.from(l, "base64"),
          ...
          Y = new Uint8Array(await n.sign("HMAC", D, d.concat([g, d.from([0, 0, 0, 1])]))),
          P = Y;
        for (var I = 0; I < y - 1; I++)
