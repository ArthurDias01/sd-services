module.exports = [
  ...
  "[project]/src/lib/auth-client.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["authClient", () => authClient]);
    var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$react$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ =
      __turbopack_context__.i(
        "[project]/node_modules/better-auth/dist/client/react/index.mjs [app-route] (ecmascript) <locals>",
      );
    const authClient = (0,
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$react$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__[
      "createAuthClient"
    ])({
  ...
  "[project]/src/lib/r2.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["uploadFile", () => uploadFile]);
    ...
    function getR2Client() {
      ...
      return new __TURBOPACK__imported__module__$5b$externals$5d2f40$aws$2d$sdk$2f$client$2d$s3__$5b$external$5d$__$2840$aws$2d$sdk$2f$client$2d$s3$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$s3$29$__[
        "S3Client"
      ]({
        region: "auto",
    ...
    async function uploadFile(file, folder = "uploads") {
      ...
      const { writeFile, mkdir } = await __turbopack_context__.A(
        "[externals]/node:fs/promises [external] (node:fs/promises, cjs, async loader)",
      );
      const nodePath = await __turbopack_context__.A(
        "[externals]/node:path [external] (node:path, cjs, async loader)",
      );
  ...
  "[project]/src/app/api/upload/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/src/lib/auth-client.ts [app-route] (ecmascript)");
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$r2$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/src/lib/r2.ts [app-route] (ecmascript)");
    async function getAdminSession() {
      let session = null;
      try {
        const result =
          await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            "authClient"
          ].getSession({
            fetchOptions: {
              headers: await (0,
    ...
    async function POST(request) {
      ...
      try {
        const results = await Promise.all(
          allFiles.map((file) =>
            (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$r2$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
              "uploadFile"
            ])(file, "uploads"),
          ),
        );
